...
namespace QuantExt {
    ...
    LargeJointCalendar::Impl::Impl(const std::vector<Calendar>& calendars,
                              JointCalendarRule r)
    : rule_(r) {
    ...
    LargeJointCalendar::LargeJointCalendar(const std::vector<Calendar>& calendars,
                                 JointCalendarRule r) {
        impl_ = ext::shared_ptr<Calendar::Impl>(
                                            new LargeJointCalendar::Impl(calendars,r));
    }
