...
namespace QuantExt {
    ...
    inline Real OvernightIndexedCrossCcyBasisSwap::recNominal() const {
        return recNominal_;
    }

    inline Currency OvernightIndexedCrossCcyBasisSwap::payCurrency() const {
        return payCurrency_;
    }

    inline Currency OvernightIndexedCrossCcyBasisSwap::recCurrency() const {
        return recCurrency_;
    }

    inline Real OvernightIndexedCrossCcyBasisSwap::paySpread() const {
        return paySpread_;
    }

    inline Real OvernightIndexedCrossCcyBasisSwap::recSpread() const {
        return recSpread_;
    }
