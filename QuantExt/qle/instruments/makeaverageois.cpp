...
namespace QuantExt {
    ...
    MakeAverageOIS::MakeAverageOIS(const Period& swapTenor,
    ...
    : swapTenor_(swapTenor),
      ...
      fixedDayCounter_(fixedDayCounter),
      spotLagTenor_(spotLagTenor),
      forwardStart_(forwardStart),
      type_(AverageOIS::Receiver),
      nominal_(1.0),
      effectiveDate_(Date()),
      spotLagCalendar_(overnightIndex->fixingCalendar()),
      fixedCalendar_(WeekendsOnly()),
      ...
      fixedFirstDate_(Date()),
      fixedNextToLastDate_(Date()),
      fixedPaymentAdjustment_(overnightIndex->businessDayConvention()),
      fixedPaymentCalendar_(overnightIndex->fixingCalendar()),
      onCalendar_(overnightIndex->fixingCalendar()),
      onConvention_(overnightIndex->businessDayConvention()),
      onTerminationDateConvention_(overnightIndex->businessDayConvention()),
      onRule_(DateGeneration::Backward),
      onEndOfMonth_(false),
      onFirstDate_(Date()),
      onNextToLastDate_(Date()),
      rateCutoff_(0),
      onSpread_(0.0),
      onGearing_(1.0),
      onDayCounter_(overnightIndex->dayCounter()),
    ...
    MakeAverageOIS::operator boost::shared_ptr<AverageOIS>() const {
        ...
        if (effectiveDate_ != Date()) {
            ...
            Date spotDate = spotLagCalendar_.advance(
                valuationDate, spotLagTenor_);
        ...
        Schedule fixedSchedule(effectiveDate, terminationDate, fixedTenor_,
            fixedCalendar_, fixedConvention_, fixedTerminationDateConvention_,
            fixedRule_, fixedEndOfMonth_, fixedFirstDate_, fixedNextToLastDate_);

        Schedule onSchedule(effectiveDate, terminationDate, onTenor_,
            onCalendar_, onConvention_, onTerminationDateConvention_,
            onRule_, onEndOfMonth_, onFirstDate_, onNextToLastDate_);

        boost::shared_ptr<AverageOIS> swap(new
    ...
    MakeAverageOIS& MakeAverageOIS::
        withFixedConvention(BusinessDayConvention fixedConvention) {
    ...
    MakeAverageOIS& MakeAverageOIS::
        withFixedRule(DateGeneration::Rule fixedRule) {
        fixedRule_ = fixedRule;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withFixedEndOfMonth(bool fixedEndOfMonth) {
        fixedEndOfMonth_ =  fixedEndOfMonth;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withFixedFirstDate(const Date& fixedFirstDate) {
        fixedFirstDate_ = fixedFirstDate;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withFixedNextToLastDate(const Date& fixedNextToLastDate) {
    ...
    MakeAverageOIS& MakeAverageOIS::
        withFixedPaymentCalendar(const Calendar& fixedPaymentCalendar) {
        fixedPaymentCalendar_ = fixedPaymentCalendar;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONCalendar(const Calendar& onCalendar) {
        onCalendar_ = onCalendar;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONConvention(BusinessDayConvention onConvention) {
    ...
    MakeAverageOIS& MakeAverageOIS::
        withONRule(DateGeneration::Rule onRule) {
        onRule_ = onRule;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONEndOfMonth(bool onEndOfMonth) {
        onEndOfMonth_ = onEndOfMonth;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONFirstDate(const Date& onFirstDate) {
        onFirstDate_ = onFirstDate;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONNextToLastDate(const Date& onNextToLastDate) {
        onNextToLastDate_ = onNextToLastDate;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withRateCutoff(Natural rateCutoff) {
        rateCutoff_ = rateCutoff;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONSpread(Spread onSpread) {
        onSpread_ = onSpread;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONGearing(Real onGearing) {
        onGearing_ = onGearing;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONDayCounter(const DayCounter& onDayCounter) {
        onDayCounter_= onDayCounter;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONPaymentAdjustment(BusinessDayConvention onPaymentAdjustment) {
        onPaymentAdjustment_ = onPaymentAdjustment;
        return *this;
    }

    MakeAverageOIS& MakeAverageOIS::
        withONPaymentCalendar(const Calendar& onPaymentCalendar) {
