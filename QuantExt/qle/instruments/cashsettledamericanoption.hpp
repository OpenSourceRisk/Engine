...
/*! \file qle/instruments/cashsettledamericanoption.hpp
    \brief cash settled american vanilla option.
    \ingroup instruments
*/

#ifndef quantext_cash_settled_american_option_hpp
#define quantext_cash_settled_american_option_hpp
...
/*! Vanilla cash settled American options allowing for deferred payment and automatic exercise.

    \ingroup instruments
*/
class CashSettledAmericanOption : public QuantLib::VanillaOption {
public:
    class arguments;
    class engine;

    //! Constructor for cash settled vanilla American option.
    CashSettledAmericanOption(QuantLib::Option::Type type, QuantLib::Real strike, const QuantLib::Date& expiryDate,
    ...
    //! Constructor for cash settled vanilla American option with digital payoff.
    CashSettledAmericanOption(QuantLib::Option::Type type, QuantLib::Real strike, QuantLib::Real cashPayoff,
    ...
    //@{
    //! Account for cash settled American options not being expired until payment is made.
...
class CashSettledAmericanOption::arguments : public QuantLib::VanillaOption::arguments {
public:
    arguments() {}
...
//! Engine
class CashSettledAmericanOption::engine
    : public QuantLib::GenericEngine<CashSettledAmericanOption::arguments, CashSettledAmericanOption::results> {};
