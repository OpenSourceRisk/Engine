...
namespace QuantExt {
    ...
    CrossCcyBasisSwap::CrossCcyBasisSwap(Real payNominal,
    ...
    void CrossCcyBasisSwap::initialize() {
        ...
        boost::shared_ptr<CashFlow> initialPayCF(new SimpleCashFlow(
        ...
        boost::shared_ptr<CashFlow> finalPayCF(new SimpleCashFlow(
        ...
        boost::shared_ptr<CashFlow> initialRecCF(new SimpleCashFlow(
        ...
        boost::shared_ptr<CashFlow> finalRecCF(new SimpleCashFlow(
