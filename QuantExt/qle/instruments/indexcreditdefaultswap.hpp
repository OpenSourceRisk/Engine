...
public:
    ...
    /*! @param side  Whether the protection is bought or sold.
        @param notional  Notional value of trade
        @param underlyingNotionals Notionals of underlyings
...
class IndexCreditDefaultSwap::arguments : public virtual PricingEngine::arguments {
public:
    arguments();
...
class IndexCreditDefaultSwap::results : public Instrument::results {
public:
    Rate fairSpread;
    Rate fairUpfront;
    Real couponLegBPS;
