...
namespace QuantExt {
    ...
    inline const boost::shared_ptr<InterestRateIndex>& FloatingAnnuityCoupon::index() const {
        return index_;
    }

    inline DayCounter FloatingAnnuityCoupon::dayCounter() const {
        return dayCounter_;
    }
        
    inline Natural FloatingAnnuityCoupon::fixingDays() const { 
        return fixingDays_; 
    }
    
    inline Real FloatingAnnuityCoupon::gearing() const { 
        return gearing_; 
    }

    inline Spread FloatingAnnuityCoupon::spread() const { 
        return spread_; 
    }
 
    inline bool FloatingAnnuityCoupon::isInArrears() const { 
        return isInArrears_; 
    }
}
