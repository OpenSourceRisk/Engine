...
namespace QuantExt {
    ...
    void
    NonStandardYoYInflationCouponPricer::setCapletVolatility(
       const Handle<YoYOptionletVolatilitySurface>& capletVol) {
    ...
    Real NonStandardYoYInflationCouponPricer::optionletPriceImp(
                                                    Option::Type,
                                                    Real,
                                                    Real,
                                                    Real) const {
    ...
    Real NonStandardYoYInflationCouponPricer::optionletPrice(Option::Type optionType,
    ...
    Real NonStandardYoYInflationCouponPricer::optionletRate(Option::Type optionType,
                                                 Real effStrike) const {
    ...
    Real NonStandardBlackYoYInflationCouponPricer::optionletPriceImp(Option::Type optionType,
                                                     Real  effStrike,
                                                     Real  forward,
                                                     Real stdDev
                                                     ) const {
    ...
    Real NonStandardUnitDisplacedBlackYoYInflationCouponPricer::optionletPriceImp(Option::Type optionType,
                                                                  Real  effStrike,
                                                                  Real  forward,
                                                                  Real stdDev
                                                          ) const {
    ...
    Real NonStandardBachelierYoYInflationCouponPricer::optionletPriceImp(Option::Type optionType,
                                                              Real  effStrike,
                                                              Real  forward,
                                                              Real stdDev
                                                          ) const {
