...
namespace QuantExt {
    ...
    public:
        MultiPathGeneratorSobolBrownianBridge(
            ...
            SobolBrownianGenerator::Ordering ordering = SobolBrownianGenerator::Diagonal, BigNatural seed = 0,
    ...
    inline const Sample<MultiPath> &MultiPathGeneratorSobol::next() const {
        return pg_->next();
    }
