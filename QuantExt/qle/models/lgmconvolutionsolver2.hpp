...
public:
    LgmConvolutionSolver2(const QuantLib::Handle<LinearGaussMarkovModel>& model, const Real sy, const Size ny,
    ...
    const QuantLib::Handle<LinearGaussMarkovModel>& model() const override { return model_; }
