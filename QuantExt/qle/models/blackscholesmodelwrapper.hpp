...
public:
    ...
    BlackScholesModelWrapper(const std::vector<QuantLib::ext::shared_ptr<StochasticProcess>>& processes,
    ...
    const std::vector<QuantLib::ext::shared_ptr<StochasticProcess>>& processes() const { return processes_; }
...
private:
    ...
    const std::vector<QuantLib::ext::shared_ptr<StochasticProcess>> processes_;
