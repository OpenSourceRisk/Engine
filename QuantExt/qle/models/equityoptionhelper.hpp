...
#ifndef quantext_calibrationhelper_equityoption_hpp
#define quantext_calibrationhelper_equityoption_hpp
...
//! Equity Option Helper
/*! \ingroup models
*/
class EquityOptionHelper : public CalibrationHelper {
public:
    /*! the equity spot is interpreted as of today (or discounted spot)
    ...
    EquityOptionHelper(const Period& maturity, const Calendar& calendar, 
                   const Real strike, const Handle<Quote> equitySpot,
    ...
    EquityOptionHelper(const Date& exerciseDate, const Real strike, 
...
private:
    ...
    Calendar calendar_;
    const Real strike_;
    const Handle<Quote> equitySpot_,fxSpot_;
