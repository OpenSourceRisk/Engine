...
public:
    ModelImpliedYieldTermStructure(const QuantLib::Handle<IrModel>& model, const DayCounter& dc = DayCounter(),
...
protected:
    ...
    const QuantLib::Handle<IrModel> model_;
...
public:
    ModelImpliedYtsFwdFwdCorrected(const QuantLib::Handle<IrModel>& model,
...
public:
    ModelImpliedYtsSpotCorrected(const QuantLib::Handle<IrModel>& model, const Handle<YieldTermStructure> targetCurve,
