...
CommoditySchwartzPiecewiseConstantParametrization::CommoditySchwartzPiecewiseConstantParametrization(const Currency& currency, const std::string& name,
    ...
    : CommoditySchwartzParametrization(currency, name, priceCurve, fxSpotToday, driftFreeState),
      PiecewiseConstantHelper1(aTimes, aConstraint, false, true),
...
Real CommoditySchwartzPiecewiseConstantParametrization::VtT(Real t, Real T) {
