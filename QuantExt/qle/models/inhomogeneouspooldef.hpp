...
#ifndef quantext_inhomogenous_pool_default_model_hpp
#define quantext_inhomogenous_pool_default_model_hpp
...
distribution object?
*/
template <class copulaPolicy> class InhomogeneousPoolLossModel : public QuantExt::DefaultLossModel {
private:
    void resetModel();
...
template <class CP> void InhomogeneousPoolLossModel<CP>::resetModel() {
...
// RL: additional flag
template <class CP> Distribution InhomogeneousPoolLossModel<CP>::lossDistrib(const Date& d, bool zeroRecovery) const {
