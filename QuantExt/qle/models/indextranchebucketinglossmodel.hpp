...
#include <qle/models/indextranchedefaultlossmodel.hpp>
...
class IndexTrancheBucketingLossModel : public IndexTrancheDefaultLossModel {

public:
    IndexTrancheBucketingLossModel(
        QuantLib::ext::shared_ptr<CreditIndexConstituentCalibration>& creditCurves,
        RelinkableHandle<Quote> baseCorrelation, 
        std::vector<double>& notionals,
        double adjustedAttachPoint, 
        double adjustedDetachPoint,
        bool homogeneous,
