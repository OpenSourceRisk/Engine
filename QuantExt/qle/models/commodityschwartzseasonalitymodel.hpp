...
*/
class CommoditySchwartzSeasonalityModel : public CommodityModel {
public:
    //enum class Discretization { Euler, Exact };

    CommoditySchwartzSeasonalityModel(const QuantLib::ext::shared_ptr<CommoditySchwartzSeasonalityParametrization>& parametrization, 
            const CommoditySchwartzModel::Discretization discretization = CommoditySchwartzModel::Discretization::Euler);
    ...
    const QuantLib::ext::shared_ptr<CommoditySchwartzSeasonalityParametrization> parametrization() const { return parametrization_; }
...
private:
    QuantLib::ext::shared_ptr<CommoditySchwartzSeasonalityParametrization> parametrization_;
    CommoditySchwartzModel::Discretization discretization_;
