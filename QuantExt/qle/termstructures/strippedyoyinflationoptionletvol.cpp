...
StrippedYoYInflationOptionletVol::StrippedYoYInflationOptionletVol(
    ...
    void StrippedYoYInflationOptionletVol::checkInputs() const {
        ...
        QL_REQUIRE(nYoYOptionletDates_ == yoyoptionletVolQuotes_.size(),
            "mismatch between number of option tenors (" <<
            nYoYOptionletDates_ << ") and number of volatility rows (" <<
        ...
        for (Size i = 1; i<nYoYOptionletDates_; ++i)
            QL_REQUIRE(yoyoptionletDates_[i]>yoyoptionletDates_[i - 1],
                ...
                " is " << yoyoptionletDates_[i - 1] << ", " <<
                io::ordinal(i + 1) << " is " << yoyoptionletDates_[i]);

        QL_REQUIRE(nStrikes_ == yoyoptionletVolQuotes_[0].size(),
            "mismatch between strikes(" << yoyoptionletStrikes_[0].size() <<
            ") and vol columns (" << yoyoptionletVolQuotes_[0].size() << ")");
        for (Size j = 1; j<nStrikes_; ++j)
            QL_REQUIRE(yoyoptionletStrikes_[0][j - 1]<yoyoptionletStrikes_[0][j],
                ...
                " is " << io::rate(yoyoptionletStrikes_[0][j - 1]) << ", " <<
                io::ordinal(j + 1) << " is " << io::rate(yoyoptionletStrikes_[0][j]));
    }
    ...
    Rate StrippedYoYInflationOptionletVol::minStrike() const {
        return yoyoptionletStrikes(0).front(); 
    }

    Rate StrippedYoYInflationOptionletVol::maxStrike() const {
        return yoyoptionletStrikes(0).back(); 
    }
    ...
    const vector<Rate>& StrippedYoYInflationOptionletVol::yoyoptionletStrikes(Size i) const {
        QL_REQUIRE(i<yoyoptionletStrikes_.size(),
            "index (" << i <<
    ...
    const vector<Volatility>& StrippedYoYInflationOptionletVol::yoyoptionletVolatilities(Size i) const {
        QL_REQUIRE(i<yoyoptionletVolatilities_.size(),
            "index (" << i <<
    ...
    const vector<Date>& StrippedYoYInflationOptionletVol::yoyoptionletFixingDates() const {
        return yoyoptionletDates_;
    }

    const vector<Time>& StrippedYoYInflationOptionletVol::yoyoptionletFixingTimes() const {
        return yoyoptionletTimes_;
    }

    DayCounter StrippedYoYInflationOptionletVol::dayCounter() const {
        return dc_;
    }

    Calendar StrippedYoYInflationOptionletVol::calendar() const {
        return calendar_;
    }

    Natural StrippedYoYInflationOptionletVol::settlementDays() const {
        return settlementDays_;
    }

    BusinessDayConvention StrippedYoYInflationOptionletVol::businessDayConvention() const {
        return businessDayConvention_;
    }

    VolatilityType StrippedYoYInflationOptionletVol::volatilityType() const {
        return type_;
    }

    Real StrippedYoYInflationOptionletVol::displacement() const {
