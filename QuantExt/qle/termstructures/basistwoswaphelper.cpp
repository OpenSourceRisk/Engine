...
namespace QuantExt {
    ...
    BasisTwoSwapHelper::BasisTwoSwapHelper(const Handle<Quote>& spread,
    ...
    : RelativeDateRateHelper(spread),
      ...
      calendar_(calendar),
      longFixedFrequency_(longFixedFrequency),
      longFixedConvention_(longFixedConvention),
      longFixedDayCount_(longFixedDayCount),
      longIndex_(longIndex),
      shortFixedFrequency_(shortFixedFrequency),
      shortFixedConvention_(shortFixedConvention),
      shortFixedDayCount_(shortFixedDayCount),
      shortIndex_(shortIndex),
      longMinusShort_(longMinusShort),
      discountHandle_(discountingCurve) {
        ...
        QL_REQUIRE(!(longIndexHasCurve && shortIndexHasCurve &&
            haveDiscountCurve), "Have all curves nothing to solve for.");
    ...
    void BasisTwoSwapHelper::initializeDates() {
        ...
        earliestDate_ = std::min(longSwap_->startDate(),
