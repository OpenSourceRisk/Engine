...
/*! \file swaptionvolcube3.hpp
    \brief Swaption volatility cube, fit-later-interpolate-early approach
*/

#ifndef quantext_swaption_volcube_3_h
#define quantext_swaption_volcube_3_h
...
namespace QuantExt {
    ...
    /*! This is the same as SwaptionVolCube2, but with flat extrapolation */
    class SwaptionVolCube3 : public SwaptionVolatilityCube {
      public:
