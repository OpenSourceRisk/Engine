...
QuantExt::RiskFactorKey::KeyType parseRiskFactorKeyType(const string& str);
QuantExt::RiskFactorKey parseRiskFactorKey(const string& str);
QuantLib::ext::shared_ptr<QuantExt::RiskFactorKey> parseRiskFactorKey(const std::string& str,
                                                                      std::vector<std::string>& addTokens);
std::pair<QuantExt::RiskFactorKey, std::string> deconstructFactor(const std::string& factor);
std::string reconstructFactor(const QuantExt::RiskFactorKey& key, const std::string& desc);

std::ostream& operator<<(std::ostream& out, const QuantExt::RiskFactorKey::KeyType& type);
std::ostream& operator<<(std::ostream& out, const QuantExt::RiskFactorKey& key);
std::ostream& operator<<(std::ostream& out, const QuantExt::ShiftScheme& shiftScheme);
std::ostream& operator<<(std::ostream& out, const QuantExt::ShiftType& shiftType);

} // namespace QuantExt

template <>
struct std::hash<QuantExt::RiskFactorKey> {
    std::size_t operator()(const QuantExt::RiskFactorKey& k) const { return hash_value(k); }
};
