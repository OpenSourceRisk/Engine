...
namespace QuantExt {
    ...
    StrippedOptionletAdapter2::smileSectionImpl(Time t) const {
    ...
    Volatility StrippedOptionletAdapter2::volatilityImpl(Time length,
                                                        Rate strike) const {
        calculate();
    ...
    Date StrippedOptionletAdapter2::maxDate() const {
        return optionletStripper_->optionletFixingDates().back();
    }

    VolatilityType StrippedOptionletAdapter2::volatilityType() const {
        return optionletStripper_->volatilityType();
    }

    Real StrippedOptionletAdapter2::displacement() const {
