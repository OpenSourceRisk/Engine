...
/*! \file kinterpolatedyoyoptionletvolatilitysurface.hpp
    \brief K-interpolated yoy optionlet volatility, with extrapolation enabled
*/
    ...
    */
    ...
    class StrikeInterpolatedYoYOptionletVolatilitySurface
      ...
      public:
        ...
        StrikeInterpolatedYoYOptionletVolatilitySurface(
    ...
    template<class Interpolator1D>
    StrikeInterpolatedYoYOptionletVolatilitySurface<Interpolator1D>::
    StrikeInterpolatedYoYOptionletVolatilitySurface(
         const Natural settlementDays,
         const Calendar& cal,
         const BusinessDayConvention bdc,
    ...
    template<class Interpolator1D>
    Date StrikeInterpolatedYoYOptionletVolatilitySurface<Interpolator1D>::
    maxDate() const {
    ...
    template<class Interpolator1D>
    Real StrikeInterpolatedYoYOptionletVolatilitySurface<Interpolator1D>::
    minStrike() const {
    ...
    template<class Interpolator1D>
    void StrikeInterpolatedYoYOptionletVolatilitySurface<Interpolator1D>::
    ...
    template<class Interpolator1D>
    Volatility StrikeInterpolatedYoYOptionletVolatilitySurface<Interpolator1D>::
