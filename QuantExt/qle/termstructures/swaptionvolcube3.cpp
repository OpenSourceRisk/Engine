...
namespace QuantExt {
    ...
    SwaptionVolCube3::SwaptionVolCube3(
    ...
    void SwaptionVolCube3::performCalculations() const{
    ...
    SwaptionVolCube3::smileSectionImpl(Time optionTime,
    ...
    boost::shared_ptr<SmileSection>
    SwaptionVolCube3::smileSectionImpl(const Date& optionDate,
