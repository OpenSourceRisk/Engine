...
#ifndef quantext_analytic_barrier_engine_hpp
#define quantext_analytic_barrier_engine_hpp
...
class AnalyticBarrierEngine : public QuantLib::AnalyticBarrierEngine {
public:
