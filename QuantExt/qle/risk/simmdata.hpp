...
namespace QuantExt {
    ...
    public:
        ...
        Size bucket(const SimmConfiguration::RiskType t, const Size qualifier) {
        ...
        const Real& amount(const SimmConfiguration::RiskType t, const SimmConfiguration::ProductClass productClass,
                           const Size qualifier, const Size label1, const Size label2) const;
    ...
    protected:
        ...
        std::map<SimmConfiguration::RiskType, Size> numberOfQualifiers_;
        // qualifier => buckets
        std::map<SimmConfiguration::RiskType, std::vector<Size> > buckets_;
