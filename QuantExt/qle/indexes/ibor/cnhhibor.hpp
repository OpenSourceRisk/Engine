...
/*! \file cnhhibor.hpp
    \brief CNH-HIBOR index
    \ingroup indexes
*/

#ifndef quantext_cnh_hibor_hpp
#define quantext_cnh_hibor_hpp
...
/*! CNH-HIBOR rate overseen by The Hong Kong Association of Banks.
    ...
    \warning Check roll convention and EOM.
            ...
            \ingroup indexes
*/
class CNHHibor : public IborIndex {
public:
    CNHHibor(const Period& tenor, const Handle<YieldTermStructure>& h = Handle<YieldTermStructure>())
        : IborIndex("CNH-HIBOR", tenor, 0, CNHCurrency(), HongKong(), ModifiedFollowing, false, Actual360(), h) {}
};
} // namespace QuantExt
