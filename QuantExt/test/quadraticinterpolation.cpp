...
BOOST_AUTO_TEST_CASE(testQuadraticInterpolation) {
    ...
    BOOST_TEST_MESSAGE("Testing QuantExt QuadraticInterpolation");
    ...
    BOOST_TEST_MESSAGE("Test calculated lambdas against cache values");
    ...
    BOOST_TEST_MESSAGE("Test interpolated values against cahced values");
