...
void SensitivityAnalysis2Test::testSensitivities() {
    ...
    portfolio->add(buildEquityOption("Eq_Option_SP5", "Long", "Call", 2, "SP5", "USD", 2147.56, 775));
    ...
    map<string, Real> analyticalResultsDelta = {{"1_Swap_EUR DiscountCurve/EUR/0/1M", 0},
                                                ...
                                                { "Eq_Option_SP5 DiscountCurve/USD/3/2Y", 1230070},
                                                { "Eq_Option_SP5 DiscountCurve/USD/4/3Y", 10169 },
                                                { "Eq_Option_SP5 EQSpot/SP5/0/spot", 835112 },
                                                { "Eq_Option_SP5 FXSpot/EURUSD/0/spot", -216083 }};
    ...
    map<string, Real> analyticalResultsGamma = {{"1_Swap_EUR DiscountCurve/EUR/0/1M", 0},
                                                ...
                                                { "Eq_Option_SP5 DiscountCurve/USD/3/2Y", 3325030 },
                                                { "Eq_Option_SP5 DiscountCurve/USD/4/3Y", 228.174 },
                                                { "Eq_Option_SP5 EQSpot/SP5/0/spot", 1461110 },
                                                { "Eq_Option_SP5 FXSpot/EURUSD/0/spot", 432169 }};
    ...
    map<string, Real> analyticalResultsCrossGamma = {
        ...
        {"Eq_Option_SP5 DiscountCurve/USD/3/2Y DiscountCurve/USD/4/3Y", 27487.1 } };
