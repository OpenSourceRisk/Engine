...
BOOST_AUTO_TEST_CASE(testSensitivities) {
    ...
    portfolio->add(buildEuropeanSwaption("5_Swaption_EUR", "Long", "EUR", true, 10.0, 10, 10, 0.02, 0.00, "1Y",
    ...
    map<string, Real> analyticalResultsDelta = {{"1_Swap_EUR DiscountCurve/EUR/0/1M", 0},
                                                ...
                                                {"5_Swaption_EUR DiscountCurve/EUR/10/20Y", 0.463374},
                                                ...
                                                {"5_Swaption_EUR DiscountCurve/EUR/8/10Y", -0.347761},
                                                {"5_Swaption_EUR DiscountCurve/EUR/9/15Y", -0.0846127},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/0/1M", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/1/6M", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/10/20Y", 113.995},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/11/30Y", 0.0440702},
                                                ...
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/8/10Y", -61.6902},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/9/15Y", 8.88668},
                                                ...
                                                {"5_Swaption_EUR SwaptionVolatility/EUR/47/10Y/10Y/ATM", 1.33878},
    ...
    map<string, Real> analyticalResultsGamma = {{"1_Swap_EUR DiscountCurve/EUR/0/1M", 0},
                                                ...
                                                {"5_Swaption_EUR DiscountCurve/EUR/0/1M", 0},
                                                {"5_Swaption_EUR DiscountCurve/EUR/1/6M", 0},
                                                {"5_Swaption_EUR DiscountCurve/EUR/10/20Y", -3.09219},
                                                ...
                                                {"5_Swaption_EUR DiscountCurve/EUR/6/5Y", 0},
                                                {"5_Swaption_EUR DiscountCurve/EUR/7/7Y", 0},
                                                {"5_Swaption_EUR DiscountCurve/EUR/8/10Y", 5.4247},
                                                {"5_Swaption_EUR DiscountCurve/EUR/9/15Y", -0.39906},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/0/1M", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/1/6M", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/10/20Y", 307503},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/11/30Y", 0.0475315},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/2/1Y", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/3/2Y", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/4/3Y", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/5/4Y", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/6/5Y", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/7/7Y", 0},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/8/10Y", 93914.6},
                                                {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/9/15Y", 2179.45},
                                                {"7_FxOption_EUR_USD DiscountCurve/EUR/0/1M", 0},
                                                {"7_FxOption_EUR_USD DiscountCurve/EUR/1/6M", 0},
                                                {"7_FxOption_EUR_USD DiscountCurve/EUR/10/20Y", 0},
                                                {"7_FxOption_EUR_USD DiscountCurve/EUR/11/30Y", 0},
    ...
    map<string, Real> analyticalResultsCrossGamma = {
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/10/20Y DiscountCurve/EUR/11/30Y", -0.00255022},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/10/20Y IndexCurve/EUR-EURIBOR-6M/10/20Y", 239.407},
        {"5_Swaption_EUR DiscountCurve/EUR/10/20Y IndexCurve/EUR-EURIBOR-6M/11/30Y", -0.281509},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/10/20Y IndexCurve/EUR-EURIBOR-6M/8/10Y", -857.907},
        {"5_Swaption_EUR DiscountCurve/EUR/10/20Y IndexCurve/EUR-EURIBOR-6M/9/15Y", 1036.57},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/11/30Y IndexCurve/EUR-EURIBOR-6M/10/20Y", 1.07528},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/11/30Y IndexCurve/EUR-EURIBOR-6M/8/10Y", -0.675703},
        {"5_Swaption_EUR DiscountCurve/EUR/11/30Y IndexCurve/EUR-EURIBOR-6M/9/15Y", 0.160581},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y DiscountCurve/EUR/10/20Y", -4.23047},
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y DiscountCurve/EUR/11/30Y", -0.00331839},
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y DiscountCurve/EUR/9/15Y", 0.253297},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y IndexCurve/EUR-EURIBOR-6M/10/20Y", -819.09},
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y IndexCurve/EUR-EURIBOR-6M/11/30Y", -0.332751},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y IndexCurve/EUR-EURIBOR-6M/8/10Y", 759.005},
        {"5_Swaption_EUR DiscountCurve/EUR/8/10Y IndexCurve/EUR-EURIBOR-6M/9/15Y", -494.965},
        {"5_Swaption_EUR DiscountCurve/EUR/9/15Y DiscountCurve/EUR/10/20Y", 1.71752},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/9/15Y IndexCurve/EUR-EURIBOR-6M/10/20Y", -661.416},
        {"5_Swaption_EUR DiscountCurve/EUR/9/15Y IndexCurve/EUR-EURIBOR-6M/11/30Y", 0.0491007},
        ...
        {"5_Swaption_EUR DiscountCurve/EUR/9/15Y IndexCurve/EUR-EURIBOR-6M/8/10Y", 430.454},
        {"5_Swaption_EUR DiscountCurve/EUR/9/15Y IndexCurve/EUR-EURIBOR-6M/9/15Y", -168.094},
        ...
        {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/10/20Y IndexCurve/EUR-EURIBOR-6M/11/30Y", 116.64},
        ...
        {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/8/10Y IndexCurve/EUR-EURIBOR-6M/10/20Y", -167406},
        {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/8/10Y IndexCurve/EUR-EURIBOR-6M/11/30Y", -67.695},
        {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/8/10Y IndexCurve/EUR-EURIBOR-6M/9/15Y", -13694.8},
        {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/9/15Y IndexCurve/EUR-EURIBOR-6M/10/20Y", 23242.8},
        {"5_Swaption_EUR IndexCurve/EUR-EURIBOR-6M/9/15Y IndexCurve/EUR-EURIBOR-6M/11/30Y", 9.41146},
