...
void SensitivityAnalysisTest::testPortfolioSensitivity() {
    ...
    simMarketData->swapVolExpiries() = {6*Months, 1*Years, 2*Years, 3*Years, 5*Years, 7*Years, 10*Years, 20*Years};
    ...
    portfolio->add(buildEuropeanSwaption("6_Swaption_EUR", "Long", "EUR", true, 1000000.0, 2, 5, 0.03, 0.00, "1Y", "30/360", "6M", "A360", "EUR-EURIBOR-6M"));    
    ...
    std::vector<Results> cachedResults = {
      { "1_Swap_EUR", "YIELD_DISCOUNT/EUR/1Y", -928826, 12.1683 },
      { "1_Swap_EUR", "YIELD_DISCOUNT/EUR/2Y", -928826, 19.0081 },
      { "1_Swap_EUR", "YIELD_DISCOUNT/EUR/3Y", -928826, 46.1186 },
      { "1_Swap_EUR", "YIELD_DISCOUNT/EUR/5Y", -928826, 85.1033 },
      { "1_Swap_EUR", "YIELD_DISCOUNT/EUR/7Y", -928826, 149.43 },
      { "1_Swap_EUR", "YIELD_DISCOUNT/EUR/10Y", -928826, 205.064 },
      { "1_Swap_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/1Y", -928826, -480.331 },
      { "1_Swap_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/2Y", -928826, 38.7816 },
      { "1_Swap_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/3Y", -928826, 94.186 },
      { "1_Swap_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/5Y", -928826, 173.125 },
      { "1_Swap_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/7Y", -928826, 304.648 },
      { "1_Swap_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/10Y", -928826, 8479.55 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/1Y", 980404, -7.11721 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/2Y", 980404, -15.8605 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/3Y", 980404, -38.0708 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/5Y", 980404, -68.7288 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/7Y", 980404, -118.405 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/10Y", 980404, -244.946 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/15Y", 980404, -202.226 },
      { "2_Swap_USD", "YIELD_DISCOUNT/USD/20Y", 980404, 0.0148314 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/1Y", 980404, -182.901 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/2Y", 980404, 47.3066 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/3Y", 980404, 113.4 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/5Y", 980404, 205.068 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/7Y", 980404, 352.859 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/10Y", 980404, 730.076 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/15Y", 980404, 8626.78 },
      { "2_Swap_USD", "YIELD_INDEX/USD-LIBOR-3M/20Y", 980404, 5.86437 },
      { "2_Swap_USD", "FX/USDEUR", 980404, 9804.04 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/1Y", 69795.3, 1.47798 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/2Y", 69795.3, -1.75066 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/3Y", 69795.3, -4.24827 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/5Y", 69795.3, -7.2252 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/7Y", 69795.3, -12.5287 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/10Y", 69795.3, -24.7828 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/15Y", 69795.3, -39.2456 },
      { "3_Swap_GBP", "YIELD_DISCOUNT/GBP/20Y", 69795.3, 31.2081 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/1Y", 69795.3, -239.702 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/2Y", 69795.3, 81.3735 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/3Y", 69795.3, 239.034 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/5Y", 69795.3, 372.209 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/7Y", 69795.3, 654.949 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/10Y", 69795.3, 1343.01 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/15Y", 69795.3, 2139.68 },
      { "3_Swap_GBP", "YIELD_INDEX/GBP-LIBOR-6M/20Y", 69795.3, 12633.8 },
      { "3_Swap_GBP", "FX/GBPEUR", 69795.3, 697.953 },
      { "4_Swap_JPY", "YIELD_DISCOUNT/JPY/1Y", 871.03, -0.00895744 },
      { "4_Swap_JPY", "YIELD_DISCOUNT/JPY/2Y", 871.03, -0.020079 },
      { "4_Swap_JPY", "YIELD_DISCOUNT/JPY/3Y", 871.03, -0.0667249 },
      { "4_Swap_JPY", "YIELD_DISCOUNT/JPY/5Y", 871.03, 4.75708 },
      { "4_Swap_JPY", "YIELD_INDEX/JPY-LIBOR-6M/1Y", 871.03, -190.575 },
      { "4_Swap_JPY", "YIELD_INDEX/JPY-LIBOR-6M/2Y", 871.03, 7.81453 },
      { "4_Swap_JPY", "YIELD_INDEX/JPY-LIBOR-6M/3Y", 871.03, 19.3576 },
      { "4_Swap_JPY", "YIELD_INDEX/JPY-LIBOR-6M/5Y", 871.03, 3832.83 },
      { "4_Swap_JPY", "FX/JPYEUR", 871.03, 8.7103 },
      { "5_Swaption_EUR", "YIELD_DISCOUNT/EUR/10Y", 18027.1, -1.33793 },
      { "5_Swaption_EUR", "YIELD_DISCOUNT/EUR/15Y", 18027.1, 0.197251 },
      { "5_Swaption_EUR", "YIELD_DISCOUNT/EUR/20Y", 18027.1, 2.41317 },
      { "5_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/10Y", 18027.1, -266.802 },
      { "5_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/15Y", 18027.1, 38.2821 },
      { "5_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/20Y", 18027.1, 487.065 },
      { "5_Swaption_EUR", "VOL_SWAPTION/EUR/10Y/10Y", 18027.1, 357.634 },
      { "6_Swaption_EUR", "YIELD_DISCOUNT/EUR/2Y", 1156.84, -0.0976825 },
      { "6_Swaption_EUR", "YIELD_DISCOUNT/EUR/3Y", 1156.84, 0.00251532 },
      { "6_Swaption_EUR", "YIELD_DISCOUNT/EUR/5Y", 1156.84, 0.00988176 },
      { "6_Swaption_EUR", "YIELD_DISCOUNT/EUR/7Y", 1156.84, 0.320953 },
      { "6_Swaption_EUR", "YIELD_DISCOUNT/EUR/10Y", 1156.84, 0.00247921 },
      { "6_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/2Y", 1156.84, -19.525 },
      { "6_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/3Y", 1156.84, 0.809505 },
      { "6_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/5Y", 1156.84, 1.79161 },
      { "6_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/7Y", 1156.84, 65.6802 },
      { "6_Swaption_EUR", "YIELD_INDEX/EUR-EURIBOR-6M/10Y", 1156.84, 0.248765 },
      { "6_Swaption_EUR", "VOL_SWAPTION/EUR/2Y/5Y", 1156.84, 47.3455 },
      { "6_Swaption_EUR", "VOL_SWAPTION/EUR/5Y/5Y", 1156.84, 0.0858115 },
      { "7_FxOption_EUR_USD", "YIELD_DISCOUNT/EUR/3Y", 1.36968e+06, -2107.81 },
      { "7_FxOption_EUR_USD", "YIELD_DISCOUNT/EUR/5Y", 1.36968e+06, -3.85768 },
      { "7_FxOption_EUR_USD", "YIELD_DISCOUNT/USD/3Y", 1.36968e+06, 1698.91 },
      { "7_FxOption_EUR_USD", "YIELD_DISCOUNT/USD/5Y", 1.36968e+06, 3.10717 },
      { "7_FxOption_EUR_USD", "FX/USDEUR", 1.36968e+06, -55979.6 },
      { "7_FxOption_EUR_USD", "VOL_FX/EURUSD/5Y", 1.36968e+06, 672236 },
      { "8_FxOption_EUR_GBP", "YIELD_DISCOUNT/EUR/7Y", 798336, -2435.22 },
      { "8_FxOption_EUR_GBP", "YIELD_DISCOUNT/GBP/7Y", 798336, 1880.89 },
      { "8_FxOption_EUR_GBP", "FX/GBPEUR", 798336, -26437.4 },
      { "8_FxOption_EUR_GBP", "VOL_FX/EURGBP/5Y", 798336, 1.36635e+06 }
    }; 
	...
	for (Size j = 1; j < scenarioGenerator->samples(); ++j ) { // skip j = 0, this is the base scenario
		...
		QL_REQUIRE(npvMap.find(p) != npvMap.end(), "pair (" << p.first << ", " << p.second << ") not found in npv map");
		QL_REQUIRE(sensiMap.find(p) != sensiMap.end(), "pair (" << p.first << ", " << p.second << ") not found in sensi map");
		BOOST_CHECK_MESSAGE(fabs(npv0 - npvMap[p]) < tolerance || fabs((npv0 - npvMap[p]) / npv0) < tolerance,
				    "npv regression failed for pair (" << p.first << ", " << p.second << "): " << npv0 << " vs " << npvMap[p]);
		BOOST_CHECK_MESSAGE(fabs(sensi - sensiMap[p]) < tolerance || fabs((sensi - sensiMap[p]) / sensi) < tolerance,
				    "sensitivity regression failed for pair (" << p.first << ", " << p.second << "): " << sensi << " vs " << sensiMap[p]);
	    }
	}
    }
...
void SensitivityAnalysisTest::test1dShifts() {
    ...
    simMarketData->yieldCurveTenors() = {1*Months, 6*Months, 1*Years, 2*Years, 3*Years, 4*Years, 5*Years, 6*Years, 7*Years, 8*Years, 9*Years, 10*Years, 12*Years, 15*Years, 20*Years, 25*Years, 30*Years};
    simMarketData->indices() = {"EUR-EURIBOR-6M", "GBP-LIBOR-6M"};
    simMarketData->interpolation() = "LogLinear";
    simMarketData->extrapolate() = true;

    simMarketData->swapVolTerms() = {1*Years, 2*Years, 3*Years, 4*Years, 5*Years, 7*Years, 10*Years, 20*Years };
    simMarketData->swapVolExpiries() = {6*Months, 1*Years, 2*Years, 3*Years, 5*Years, 7*Years, 10*Years, 20*Years};
    simMarketData->swapVolCcys() = ccys;
    simMarketData->swapVolDecayMode() = "ForwardVariance";
    ...
    for (Size i = 0; i < shiftTenors.size(); ++i) {
        scenarioGenerator->applyShift(i, shiftSize, shiftTypeAbsolute, shiftTimes, initialZeros, times, shiftedZeros);
	for (Size j = 0; j < tenors.size(); ++j)
	    diffAbsolute[j] += shiftedZeros[j] - initialZeros[j];
        scenarioGenerator->applyShift(i, shiftSize, shiftTypeRelative, shiftTimes, initialZeros, times, shiftedZeros);
	for (Size j = 0; j < tenors.size(); ++j)
    ...
    for (Size j = 0; j < tenors.size(); ++j) {
        ...
        BOOST_CHECK_MESSAGE(fabs(diffAbsolute[j] - shiftSize) < tolerance, "inconsistency in absolute 1d shifts at curve tenor point " << j);
        BOOST_CHECK_MESSAGE(fabs(diffRelative[j] - shiftSize) < tolerance, "inconsistency in relative 1d shifts at curve tenor point " << j);
    }
}
...
void SensitivityAnalysisTest::test2dShifts() {
    ...
    for (Size i = 0; i < expiryShiftTenors.size(); ++i) {
        for (Size j = 0; j < termShiftTenors.size(); ++j) {
	    scenarioGenerator->applyShift(i, j, shiftSize, shiftTypeAbsolute, shiftExpiryTimes, shiftTermTimes, expiryTimes, termTimes, initialData, shiftedData);
	    for (Size k = 0; k < expiries.size(); ++k) {
	        for (Size l = 0; l < terms.size(); ++l)
		    diffAbsolute[k][l] += shiftedData[k][l] - initialData[k][l];
	    }
	    scenarioGenerator->applyShift(i, j, shiftSize, shiftTypeRelative, shiftExpiryTimes, shiftTermTimes, expiryTimes, termTimes, initialData, shiftedData);
	    for (Size k = 0; k < expiries.size(); ++k) {
	        for (Size l = 0; l < terms.size(); ++l)
    ...
    for (Size k = 0; k < expiries.size(); ++k) {
        for (Size l = 0; l < terms.size(); ++l) {
	  //BOOST_TEST_MESSAGE("2d shift: checking sensitivity to underlying grid point (" << k << ", " << l << "): " << diff[k][l]);
	  BOOST_CHECK_MESSAGE(fabs(diffAbsolute[k][l] - shiftSize) < tolerance, "inconsistency in absolute 2d shifts at grid point (" << k << ", " << l << "): "
			      << diffAbsolute[k][l]);
	  BOOST_CHECK_MESSAGE(fabs(diffRelative[k][l] - shiftSize) < tolerance, "inconsistency in relative 2d shifts at grid point (" << k << ", " << l << "): "
			      << diffRelative[k][l]);
    	}
    }
}
