...
void testPortfolioSensitivity(ObservationMode::Mode om) {
    ...
    factory->registerBuilder(boost::make_shared<FxEuropeanVanillaOptionAnalyticEngineBuilder>());
    ...
    factory->registerBuilder(boost::make_shared<EquityEuropeanVanillaOptionAnalyticEngineBuilder>());
