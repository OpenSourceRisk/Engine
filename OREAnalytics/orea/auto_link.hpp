...
#elif(_MSC_VER == 1310)
#define OPEN_SOURCE_RISKANALYTICS_LIB_TOOLSET "vc71"
#elif(_MSC_VER == 1400)
#define OPEN_SOURCE_RISKANALYTICS_LIB_TOOLSET "vc80"
#elif(_MSC_VER == 1500)
#ifdef x64
#define OPEN_SOURCE_RISKANALYTICS_LIB_TOOLSET "vc90-x64"
#else
#define OPEN_SOURCE_RISKANALYTICS_LIB_TOOLSET "vc90"
#endif
#elif(_MSC_VER == 1600)
