...
#include <orea/simm/simmconfigurationisdav2_8_2512_2.hpp>
...
namespace ore {
namespace analytics {
QuantLib::Size SimmConfiguration_ISDA_V2_8_2512_2::group(const string& qualifier, const std::map<QuantLib::Size,
...
QuantLib::Real SimmConfiguration_ISDA_V2_8_2512_2::weight(const CrifRecord::RiskType& rt, QuantLib::ext::optional<string> qualifier,
...
QuantLib::Real SimmConfiguration_ISDA_V2_8_2512_2::correlation(const CrifRecord::RiskType& firstRt, const string& firstQualifier,
...
SimmConfiguration_ISDA_V2_8_2512_2::SimmConfiguration_ISDA_V2_8_2512_2(const QuantLib::ext::shared_ptr<SimmBucketMapper>& simmBucketMapper,
    ...
    if (mporDays == 10) {
        simmConcentration_ = QuantLib::ext::make_shared<SimmConcentration_ISDA_V2_8_2512_2>(simmBucketMapper_);
    } else {
...
of the ISDA-SIMM-v2.8+2512.2 documentation).
*/
QuantLib::Real SimmConfiguration_ISDA_V2_8_2512_2::curvatureMarginScaling() const { return pow(hvr_ir_, -2.0); }

void SimmConfiguration_ISDA_V2_8_2512_2::addLabels2(const CrifRecord::RiskType& rt, const string& label_2) {
    // Call the shared implementation
    SimmConfigurationBase::addLabels2Impl(rt, label_2);
}

string SimmConfiguration_ISDA_V2_8_2512_2::label2(const QuantLib::ext::shared_ptr<InterestRateIndex>& irIndex) const {
    // Special for BMA
