...
/*! \file orea/simm/simmconfigurationisdav2_6_5.hpp
    \brief SIMM configuration for SIMM version 2.6.5
*/
...
/*! Class giving the SIMM configuration as outlined in the document
    <em>ISDA SIMM Methodology, version 2.6.5.
        Effective Date: December 7, 2024.</em>
*/
class SimmConfiguration_ISDA_V2_6_5 : public SimmConfigurationBase {
public:
    SimmConfiguration_ISDA_V2_6_5(const QuantLib::ext::shared_ptr<SimmBucketMapper>& simmBucketMapper,
                                const QuantLib::Size& mporDays = 10,
                                const std::string& name = "SIMM ISDA 2.6.5 (7 December 2024)",
