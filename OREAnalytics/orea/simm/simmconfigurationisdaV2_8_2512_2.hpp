...
public:
    ...
    QuantLib::Real weight(const CrifRecord::RiskType& rt, QuantLib::ext::optional<std::string> qualifier = boost::none,
                          QuantLib::ext::optional<std::string> label_1 = boost::none,
