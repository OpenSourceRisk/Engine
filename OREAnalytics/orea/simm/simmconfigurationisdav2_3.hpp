...
/*! \file orea/simm/simmconfigurationisdav2_3.hpp
    \brief SIMM configuration for SIMM version 2.3
*/
...
/*! Class giving the SIMM configuration as outlined in the document
    <em>ISDA SIMM Methodology, version 2.3.
        Effective Date: December 5, 2020.</em>
*/
class SimmConfiguration_ISDA_V2_3 : public SimmConfigurationBase {
public:
    SimmConfiguration_ISDA_V2_3(const QuantLib::ext::shared_ptr<SimmBucketMapper>& simmBucketMapper,
                                const QuantLib::Size& mporDays = 10,
                                const std::string& name = "SIMM ISDA 2.3 (8 July 2020)",
