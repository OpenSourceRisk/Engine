...
/*! \file orea/simm/simmconcentrationisdav2_8_2506.hpp
    \brief SIMM concentration thresholds for SIMM version 2.8+2506
*/
...
/*! Class giving the SIMM concentration thresholds as outlined in the document
    <em>ISDA SIMM Methodology, version 2.8+2506 .
        Effective Date: December 06, 2025.</em>
*/
class SimmConcentration_ISDA_V2_8_2506 : public SimmConcentrationBase {
public:
    //! Default constructor that adds fixed known mappings
    SimmConcentration_ISDA_V2_8_2506(const QuantLib::ext::shared_ptr<SimmBucketMapper>& simmBucketMapper);
