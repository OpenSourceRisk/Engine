...
QuantLib::Real SimmConfiguration_ISDA_V2_5::weight(const RiskType& rt, QuantLib::ext::optional<string> qualifier,
...
*/
QuantLib::Real SimmConfiguration_ISDA_V2_5::curvatureMarginScaling() const { return std::pow(hvr_ir_, -2.0); }
