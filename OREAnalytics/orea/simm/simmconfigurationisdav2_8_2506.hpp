...
/*! \file orea/simm/simmconfigurationisdav2_8_2506.hpp
    \brief SIMM configuration for SIMM version 2.8+2506
*/
...
public:
    SimmConfiguration_ISDA_V2_8_2506(const QuantLib::ext::shared_ptr<SimmBucketMapper>& simmBucketMapper,
