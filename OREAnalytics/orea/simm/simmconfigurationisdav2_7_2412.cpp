...
QuantLib::Real SimmConfiguration_ISDA_V2_7_2412::weight(const CrifRecord::RiskType& rt, QuantLib::ext::optional<string> qualifier,
...
QuantLib::Real SimmConfiguration_ISDA_V2_7_2412::correlation(const CrifRecord::RiskType& firstRt,
...
SimmConfiguration_ISDA_V2_7_2412::SimmConfiguration_ISDA_V2_7_2412(const QuantLib::ext::shared_ptr<SimmBucketMapper>& simmBucketMapper,
    ...
    if (mporDays_ == 10) {
        ...
        historicalVolatilityRatios_[CrifRecord::RiskType::CommodityVol] = 0.90;
...
*/
QuantLib::Real SimmConfiguration_ISDA_V2_7_2412::curvatureMarginScaling() const { return std::pow(hvr_ir_, -2.0); }
