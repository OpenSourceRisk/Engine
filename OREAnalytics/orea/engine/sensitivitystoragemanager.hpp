...
public:
    ...
    virtual void addSensitivities(boost::shared_ptr<ore::analytics::NPVCube> cube,
...
public:
    ...
    void addSensitivities(boost::shared_ptr<ore::analytics::NPVCube> cube,
                          const boost::shared_ptr<ore::data::Trade>& trade,
                          const boost::shared_ptr<ore::data::Market>& market,
                          const QuantLib::Size dateIndex = QuantLib::Null<QuantLib::Size>(),
...
private:
    ...
    processSwapSwaption(boost::shared_ptr<ore::analytics::NPVCube> cube,
                        const boost::shared_ptr<ore::data::Trade>& trade,
