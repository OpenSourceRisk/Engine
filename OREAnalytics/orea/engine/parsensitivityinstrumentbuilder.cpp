...
ParSensitivityInstrumentBuilder::Instruments ParSensitivityInstrumentBuilder::createParInstruments(
    ...
    const boost::shared_ptr<ore::analytics::ScenarioSimMarket>& simMarket) const {
...
std::pair<boost::shared_ptr<Instrument>, Date> ParSensitivityInstrumentBuilder::makeSwap(
    ...
    std::set<ore::analytics::RiskFactorKey>& parHelperDependencies_, const string& expDiscountCurve) const {
...
ParSensitivityInstrumentBuilder::makeDeposit(const boost::shared_ptr<Market>& market, string ccy, string indexName,
...
std::pair<boost::shared_ptr<Instrument>, Date>
ParSensitivityInstrumentBuilder::makeFRA(const boost::shared_ptr<Market>& market, string ccy, string indexName,
                                         string yieldCurveName, string equityForecastCurveName, Period term,
                                         const boost::shared_ptr<Convention>& convention) {
    // Curve priorities, use in the following order if ccy/indexName/yieldCurveName strings are not blank
...
ParSensitivityInstrumentBuilder::makeYoYCapFloor(const boost::shared_ptr<Market>& market, string indexName, Period term,
                                                 Real strike, const boost::shared_ptr<Convention>& convention,
                                                 bool singleCurve, bool fromZero, const std::string& expDiscountCurve,
