...
XvaEngineCG::getRegressors(const std::size_t dateIndex, const Date& obsDate,
                           const std::set<std::pair<Size, Size>>& tradeIds, const bool isValuation) {
