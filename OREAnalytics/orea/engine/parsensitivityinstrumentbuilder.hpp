...
public:
    struct Instruments {
        ...
        std::map<ore::analytics::RiskFactorKey, boost::shared_ptr<QuantLib::Instrument>> parHelpers_;
    ...
    void createParInstruments(ParSensitivityInstrumentBuilder::Instruments& instruments, const QuantLib::Date& asof,
...
private:
    ...
    makeDeposit(const QuantLib::Date& asof, const boost::shared_ptr<ore::data::Market>& market, std::string ccy,
                std::string indexName, std::string yieldCurveName, std::string equityForecastCurveName, QuantLib::Period term,
                const boost::shared_ptr<ore::data::Convention>& conventions,
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeFRA(const QuantLib::Date& asof, const boost::shared_ptr<ore::data::Market>& market, std::string ccy,
            std::string indexName, std::string yieldCurveName, std::string equityForecastCurveName, QuantLib::Period term,
            const boost::shared_ptr<ore::data::Convention>& conventions,
            const std::string& marketConfiguration = ore::data::Market::defaultConfiguration) const;
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeSwap(const boost::shared_ptr<ore::data::Market>& market, std::string ccy, std::string indexName, std::string yieldCurveName,
             std::string equityForecastCurveName, QuantLib::Period term, const boost::shared_ptr<ore::data::Convention>& conventions,
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeOIS(const boost::shared_ptr<ore::data::Market>& market, std::string ccy, std::string indexName, std::string yieldCurveName,
            std::string equityForecastCurveName, QuantLib::Period term, const boost::shared_ptr<ore::data::Convention>& conventions,
            bool singleCurve, std::set<ore::analytics::RiskFactorKey>& parHelperDependencies,
            std::set<std::string>& removeTodaysFixingIndices, const std::string& expDiscountCurve = "",
            const std::string& marketConfiguration = ore::data::Market::defaultConfiguration) const;
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeTenorBasisSwap(const QuantLib::Date& asof, const boost::shared_ptr<ore::data::Market>& market, std::string ccy,
    ...
    boost::shared_ptr<QuantLib::CapFloor> makeCapFloor(
        const boost::shared_ptr<ore::data::Market>& market, std::string ccy, std::string indexName, QuantLib::Period term, double strike,
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeCrossCcyBasisSwap(const boost::shared_ptr<ore::data::Market>& market, std::string baseCcy, std::string ccy, QuantLib::Period term,
                          const boost::shared_ptr<ore::data::Convention>& conventions,
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeFxForward(const boost::shared_ptr<ore::data::Market>& market, std::string baseCcy, std::string ccy, QuantLib::Period term,
                  const boost::shared_ptr<ore::data::Convention>& conventions,
                  std::set<ore::analytics::RiskFactorKey>& parHelperDependencies,
                  const std::string& marketConfiguration = ore::data::Market::defaultConfiguration) const;
    ...
    std::pair<boost::shared_ptr<QuantLib::Instrument>, Date>
    makeCDS(const boost::shared_ptr<ore::data::Market>& market, std::string name, std::string ccy, QuantLib::Period term,
            const boost::shared_ptr<ore::data::Convention>& conventions,
            std::set<ore::analytics::RiskFactorKey>& parHelperDependencies, const std::string& expDiscountCurve = "",
            const std::string& marketConfiguration = ore::data::Market::defaultConfiguration) const;
    ...
    makeZeroInflationSwap(const boost::shared_ptr<ore::data::Market>& market, std::string indexName, QuantLib::Period term,
                          const boost::shared_ptr<ore::data::Convention>& conventions, bool singleCurve,
                          std::set<ore::analytics::RiskFactorKey>& parHelperDependencies,
    ...
    boost::shared_ptr<QuantLib::Instrument>
    makeYoyInflationSwap(const boost::shared_ptr<ore::data::Market>& market, std::string indexName, QuantLib::Period term,
                         const boost::shared_ptr<ore::data::Convention>& conventions, bool singleCurve, bool fromZero,
                         std::set<ore::analytics::RiskFactorKey>& parHelperDependencies,
                         const std::string& expDiscountCurve = "",
                         const std::string& marketConfiguration = ore::data::Market::defaultConfiguration) const;
    ...
    void makeYoYCapFloor(ParSensitivityInstrumentBuilder::Instruments& instruments,
                         const boost::shared_ptr<Market>& market, std::string indexName, QuantLib::Period term,
                         double strike, const boost::shared_ptr<ore::data::Convention>& convention, bool singleCurve,
