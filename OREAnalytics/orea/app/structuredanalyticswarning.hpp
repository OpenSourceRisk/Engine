...
public:
    StructuredAnalyticsWarningMessage(const std::string& analyticType, const std::string& warningType, const std::string& warningWhat)
        : StructuredMessage("Warning", "Analytics", warningWhat,
