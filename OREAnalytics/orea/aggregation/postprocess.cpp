...
PostProcess::PostProcess(const QuantLib::ext::shared_ptr<Portfolio>& portfolio,
                         ...
                         const string& dvaName, const string& borrowingCurve, const string& lendingCurve,
    ...
    : portfolio_(portfolio), nettingSetManager_(nettingSetManager), collateralBalances_(collateralBalances),
      ...
      borrowingCurve_(borrowingCurve), lendingCurve_(lendingCurve), dimCalculator_(dimCalculator),
    ...
    if (analytics_["dynamicCredit"]) {
        cvaCalculator_ = QuantLib::ext::make_shared<DynamicCreditXvaCalculator>(
            ...
            borrowingCurve_, lendingCurve_, analytics_["dva"], analytics_["fva"], analytics_["mva"], analytics_["dim"],
    ...
    if (analytics_["dynamicCredit"]) {
        allocatedCvaCalculator_ = QuantLib::ext::make_shared<DynamicCreditXvaCalculator>(
            portfolio_, market_, configuration_, baseCurrency_, dvaName_, borrowingCurve_, lendingCurve_,
            analytics_["dva"], analytics_["fva"], analytics_["mva"],
