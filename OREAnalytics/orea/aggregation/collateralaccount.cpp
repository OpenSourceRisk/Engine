...
namespace {
bool isMarginCallExpired(openriskengine::analytics::CollateralAccount::MarginCall mc) {
    return !mc.openMarginRequest();
}

bool isMarginPayDateLessThan(openriskengine::analytics::CollateralAccount::MarginCall mc1,
                             openriskengine::analytics::CollateralAccount::MarginCall mc2) {
