...
\begin{supertabular}{|p{2.2cm}|p{4.0cm}|p{9cm}|}
  ...
  26-06-2025 & Peter Caspers & add purpose tag amccg \\
  07-07-2025 & Peter Caspers & add amccg components node for exposure \\
  28-11-2025 & Roland Lichters & add Heston pricing engine configuration
 \\ \hline
\end{supertabular}
\end{center}
...
\bibitem{dimitroff_2011}
  G.Dimitroff, S.~Lorenz, A.~Szimayer: A Parsimonious Multi-Asset Heston Model (March 3, 2011).
  Available at SSRN: \url{https://ssrn.com/abstract=1435199}

\bibitem{innocentis_2016}
  M.~de Innocentis, R.~Lichters, M.~Trahe: Efficient Simulation of the Multi Asset Heston Model (February 15, 2016).
  Available at SSRN: \url{https://ssrn.com/abstract=2729475}

\bibitem{cesarini_2014}
  A.~Cesarini and S.~Giovannitti: Quanto Implied Volatility Smile (January 30, 2014).
  Available at SSRN: \url{https://ssrn.com/abstract=2388093}

\bibitem{stackexchange_40521}
  \url{https://quant.stackexchange.com/questions/40521/quanto-pricing-explanation}
