...
flipping the signs. Note that the variance drift adjustment has the potential, depending the sign of correlations,
to push the variance process towards the boundary $V=0$, especially when working with relaxed Feller constraints
-- to be controlled in the implementaton of the variance process.
