...
\begin{minted}[fontsize=\footnotesize]{xml}
   <Product type="ScriptedTrade">
    ...
    <EngineParameters>
      ...
      <Parameter name="GenerateAdditionalResultsPathLevel">false</Parameter>
...
\item GenerateAdditionalResultsPathLevel: if true, generate additional results on path level
