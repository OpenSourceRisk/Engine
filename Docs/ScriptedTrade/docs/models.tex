...
\begin{minted}[fontsize=\footnotesize]{xml}
   <Product type="ScriptedTrade">
    ...
    <EngineParameters>
      ...
      <Parameter name="Heston.Debug">true</Parameter>
    </EngineParameters>
  </Product>
\end{minted}
...
\item Heston-specific parameters [Optional]:
  ...
  \item Heston.Debug [Optional]: If set to true or Y, we generate a report (assetmodel\_paths.csv) that contains the spot price realisations
    across all indices, effective simulation dates and MC samples for each trade; moreover we perform additional consistency
    checks during Heston path generation. \\
    Default: false
  \end{itemize}
\end{itemize}
