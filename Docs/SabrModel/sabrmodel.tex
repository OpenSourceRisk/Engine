...
\begin{itemize}
\item $F$ a forward rate or price, e.g. a forward swap rate, a forward libor or overnight term rate
...
\item $\rho$ the correlation between the Wiener processes driving forward and volatility
\end{itemize}
...
FlochKennedy & $[-d, \infty)$ & Shifted Lognormal Volaility \\
\end{tabular}
...
value for the optimization will be set to

\begin{eqnarray}
x_0 &=& (\epsilon_1 + 0.01 h_0) / \max(f+d,\epsilon_1)^\beta \\
x_1 &=& \epsilon_1 + h_1 \epsilon_2 \\
x_2 &=& \epsilon_1 + m_\nu h_2 \\
x_3 &=& \epsilon_2 ( 2h_3 - 1 )
\end{eqnarray}
