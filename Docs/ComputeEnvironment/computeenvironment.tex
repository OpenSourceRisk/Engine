...
\item \verb+declareOutputVariable()+: declare a variable with given id as part of the output vector. An input variable
  should not be declared as an output variable, this might work for certain implementations, but is generally not
  guaranteed to work.
