...
public:
    ...
    // computation graph
    ext::make_shared<QuantExt::ComputationGraph> computationGraph() { return g_; }
...
\begin{listing}[hbt]
\begin{minted}[fontsize=\scriptsize]{c++}
void XvaAnalyticImpl::runAnalytic(const ext::make_shared<ore::data::InMemoryLoader>& loader,
...
This would be more consistent with the plan vanilla trades and would not require a distinction of vanilla and exotic
