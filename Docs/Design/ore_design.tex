...
int main(int argc, char** argv) {
	...
	ext::make_shared<Parameters> params = ext::make_shared<Parameters>();
	try {
...
void build(const ext::make_shared<EngineFactory>&);
//! Return trade list
const std::vector<ext::make_shared<Trade>>& trades() const { return trades_; }
// ...
};
\end{minted}
...
virtual void build(const ext::make_shared<EngineFactory>&) = 0;
...
const ext::make_shared<InstrumentWrapper>& instrument() { return instrument_; }
...
virtual const ext::make_shared<FixingManager>& fixingManager() const = 0;
protected:
Real numeraire_;
};
\end{minted}
...
ext::make_shared<ScenarioGenerator>& scenarioGenerator() { return scenarioGenerator_; }
//! Set aggregation data
ext::make_shared<AggregationScenarioData>& aggregationScenarioData() { return asd_; }
//! Set scenarioFilter
ext::make_shared<ScenarioFilter>& filter() { return filter_; }
//! Update market snapshot and relevant fixing history
void update(const Date& d) override;
//! Reset sim market to initial state
virtual void reset() override;
//! Return the fixing manager
const ext::make_shared<FixingManager>& fixingManager() const override { return fixingManager_; }
// ...
};
\end{minted}
...
virtual ext::make_shared<Scenario> clone() const = 0;
// ...
};
\end{minted}
...
%%\hrule\medskip
%\begin{minted}[fontsize=\footnotesize]{cpp}
%	ext::make_shared<XvaRunner> xva = getXvaRunner();
...
void PricingAnalyticImpl::runAnalytic( 
    const ext::make_shared<ore::data::InMemoryLoader>& loader, 
