...
Though both bond engines inherit from \verb+McMultiLegBaseEngine+ bespoke \verb+calculate()+ and \verb+amcCalculator()+ methods are in place for the bond flavours.
