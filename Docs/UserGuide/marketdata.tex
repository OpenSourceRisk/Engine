...
\centering
  ...
  \hline
    ...
    ContractMonth & Alphanumeric string of the form YYYY-MM & Contract month and year\\ \hline
    Contract & String & Contract name\\ \hline
...
Contract month is quoted here as YYYY-MM. The exact expiry date follows from a date rule defined in the future
conventions, see \ref{ss:conventions_future}.
