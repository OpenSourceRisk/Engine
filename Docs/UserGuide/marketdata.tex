...
\hline
  ...
  RATE, RATIO, PRICE, RATE\_LNVOL, RATE\_NVOL, RATE\_SLNVOL,
    BASE\_CORRELATION, SHIFT, SHAPE\_FACTOR} \\
\hline
  \end{tabular}
...
This quote provides the price for a specified bond. The reference data of the bond specifies the further characteristics
of the price, i.e. type (clean or dirty) and quote method (percentage of par or currency per unit).
...
\centering
  ...
  \hline
  {\bf Property} & {\bf Allowable values} & {\bf Description} \\ \hline
    Instrument Type & \emph{BOND\_FUTURE} & \\ \hline
    Quote Type & \emph{PRICE} & \\ \hline
    Name & String & Identifying name of the future contract \\ \hline
  \end{tabular}
  \caption{Bond Future Prices}
  \label{tab:bondfutureprice_quote}
\end{table}
...
Examples:
\begin{itemize}
	\item BOND\_FUTURE/PRICE/TYH25
\end{itemize}

%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsection{Bond Future Conversion Factor}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
\centering
  ...
  {\bf Property} & {\bf Allowable values} & {\bf Description} \\ \hline
    ...
    Name & String & Identifying name of the bond \\ \hline
    FutureContract & String & Identifying name of the future contract \\ \hline
  \end{tabular}
  \caption{Bond Conversion Factor}
  \label{tab:bond_future_conversion_factor}
\end{table}
...
Examples:
\begin{itemize}
	\item BOND\_FUTURE/CONVERSION\_FACTOR/ISIN:US91282CNF40/TYU25
\end{itemize}
...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsection{Bond Future Option Implied Volatility}
\label{md:bond_future_option_iv}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
\begin{table}[H]
    ...
    \hline
    {\bf Property} & {\bf Allowable values} & {\bf Description} \\ \hline
    Instrument Type & \emph{BOND\_FUTURE\_OPTION} & \\ \hline
    Quote Type & \emph{RATE\_LNVOL} & \\ \hline
    Name & String & Underlying bond future contract name \\ \hline
    Expiry & Date string & Expiry date of the option \\ \hline
    Strike & Real & Absolute strike price of the option \\ \hline
    CallPut & \lstinline!C! or \lstinline!P! & Optional flag indicating if volatility is for call or put \\ \hline
    \end{tabular}
    \caption{Bond Future Option Implied Volatility}
    \label{tab:bond_future_option_iv_quote}
\end{table}

Note that how the strike from the quote string is interpreted depends on the \lstinline!StrikeFactor! 
provided in the curve configuration for the bond future volatility structures. The strike from the 
quote string is divided by this value. So, for example, a strike in the quote string of 
\lstinline!121.25! along with a \lstinline!StrikeFactor! of \lstinline!100! in the curve configuration 
would interpret the strike as $1.2125$. Another option in this example would be to use \lstinline!1.2125! 
directly in the quote string and use a \lstinline!StrikeFactor! of \lstinline!1! in the curve configuration 
or omit it letting it default to \lstinline!1!.

\medskip
Example:
\begin{itemize}
    \item \lstinline!BOND_FUTURE_OPTION/RATE_LNVOL/TYM26/2026-04-02/121.25/C!
    \item \lstinline!BOND_FUTURE_OPTION/RATE_LNVOL/TYM26/2026-04-02/121.25/P!
    \item \lstinline!BOND_FUTURE_OPTION/RATE_LNVOL/TYM26/2026-04-02/1.2125/P!
    \item \lstinline!BOND_FUTURE_OPTION/RATE_LNVOL/TYM26/2026-04-02/1.2125!
\end{itemize}

%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsection{Bond Future Option Premium}
\label{md:bond_future_option_premium}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
\begin{table}[H]
    ...
    Expiry & Date string & Expiry date of the option \\ \hline
    Strike & Real & Absolute strike price of the option \\ \hline
    CallPut & \lstinline!C! or \lstinline!P! & Indicates if premium is for call or put \\ \hline
    \end{tabular}
    \caption{Bond Future Option Premium}
    \label{tab:bond_future_option_premium_quote}
\end{table}

See comment in Section~\ref{md:bond_future_option_iv} regarding the strike price. Also, note that 
the \lstinline!CallPut! flag is mandatory for premium quotes.

\medskip
Example:
\begin{itemize}
    \item \lstinline!BOND_FUTURE_OPTION/PRICE/TYM26/2026-04-02/121.25/C!
    \item \lstinline!BOND_FUTURE_OPTION/PRICE/TYM26/2026-04-02/121.25/P!
    \item \lstinline!BOND_FUTURE_OPTION/PRICE/TYM26/2026-04-02/1.2125/P!
\end{itemize}
