...
Expiry month is quoted here as YYYY-MM or \texttt{[FGHJKMNQUVXZ][0-9]\{1,2\}}. The exact expiry date follows from a date rule defined in the future
...
Contract month is quoted here as YYYY-MM or \texttt{[FGHJKMNQUVXZ][0-9]\{1,2\}}. The exact expiry date follows from a date rule defined in the future
conventions, see \ref{ss:conventions_future}.
