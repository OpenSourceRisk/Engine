...
\centering
  ...
  \hline
    ...
    Expiry & Alphanumeric string of the form YYYY-MM or \texttt{[FGHJKMNQUVXZ][0-9]\{1,2\}} & Expiry month and year or delivery month code\\ \hline
...
Contract month is quoted here as YYYY-MM or using contract month codes, see table \ref{tab:contract_month_codes}. Contract
month codes are combined with one or two digits representing the contract year. For a single digit, the decade of the
valuation date is implied. The underlying dates follow from a date rule defined in the future conventions, see
\ref{ss:conventions_future}.

\medskip
Example:
\begin{itemize}
\item {MM\_FUTURE/PRICE/EUR/2018-06/LIF3ME/3M}
\item {MM\_FUTURE/PRICE/EUR/M18/LIF3ME/3M}
\end{itemize}
...
\centering
  ...
  \hline
    ...
    ContractMonth & Alphanumeric string of the form YYYY-MM or \texttt{[FGHJKMNQUVXZ][0-9]\{1,2\}} & Contract month and year or delivery month code\\ \hline
    Contract & String & Contract name\\ \hline
...
\item {OI\_FUTURE/PRICE/USD/Z19/CME:SR3Z2019/3M}
\end{itemize}
...
\centering
  ...
  \hline
    ...
    Z & Dec \\ \hline
  \end{tabular}
  \caption{Contract Month Codes}
  \label{tab:contract_month_codes}
\end{table}
...
\input{marketdata_intradaypower}
