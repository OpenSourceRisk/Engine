...
\begin{enumerate}
\item With CMake 3.30.0+ and Boost 1.70.0+, set the environment variable ORE_BOOST_DIR or BOOST_DIR to the directory containing the 
Boost CMake package configuration file i.e. the file BoostConfig.cmake. ORE_BOOST_DIR is provided to allow for a selected version of
...
environment variables BOOST and BOOST_LIB64 to point to the Boost root directory and Boost lib directory respectively, e.g:
\begin{itemize}
...
\begin{tabular}{|p{5.5cm}|p{6cm}|p{3cm}|}
  ...
  \hline
  QL\_USE\_STD\_CLASSES & Enable all QL_USE_STD_ options & OFF\textsuperscript{*} \\
  \hline
