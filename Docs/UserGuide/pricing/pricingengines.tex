...
%--------------------------------------------------------
\subsection{Product Type: EuropeanSwaption\_NonStandard\_XCcy}
%--------------------------------------------------------
\label{sec:EuropeanSwaption_ns_XCcy_pt}
A pricing product type similar to NonStandard European Swaption in subsection \ref{sec:EuropeanSwaption_ns_pt}, but for
...
%--------------------------------------------------------
\subsection{Product Type: BermudanSwaption\_NonStandard\_XCcy}
%--------------------------------------------------------
\label{sec:BermudanSwaption_ns_XCcy_pt}
A pricing product type similar to NonStandard Bermudan Swaption in subsection \ref{sec:BermudanSwaption_ns_pt}, but for
the multi-currency case.
...
%--------------------------------------------------------
\subsection{Product Type: AmericanSwaption\_NonStandard\_XCcy}
%--------------------------------------------------------
\label{sec:AmericanSwaption_ns_XCcy_pt}
A pricing product type similar to NonStandard American Swaption in subsection \ref{sec:AmericanSwaption_ns_pt}, but for
the multi-currency case.
