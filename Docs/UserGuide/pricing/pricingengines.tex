...
Model Parameters:
\begin{itemize}
    \item Volatility [optional]: Selects the pricing model. If omitted, defaults to Kirk approximation.
    \begin{itemize}
        \item \textbf{normal}: Use Bachelier model
        \item \textbf{lognormal}: Use Kirk approximation
    \end{itemize}
\end{itemize}
