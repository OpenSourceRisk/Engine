...
\begin{itemize}
\item SensitivityTemplate [optional]: the sensitivity template to use
\item UseEquityConvexityAdjustment [optional]: whether convexity adjustment will be used for equity swap, default to \emph{false}
\item EquityConvexityAdjustmentCurrencyPairList [optional]: the currency pairs that the equity convexity adjustment will apply on. The convexity adjustment multiplier is given by:
...
<Product type="Swap">
    ...
    <EngineParameters>
        <Parameter name="SensitivityTemplate">IR_Analytical</Parameter>
		<Parameter name="UseEquityConvexityAdjustment">N</Parameter>
		<Parameter name="EquityConvexityAdjustmentCurrencyPairList">USDEUR</Parameter>
    </EngineParameters>
</Product>
\end{minted}
