...
\begin{itemize}
    ...
    \item For spreads between two different underlyings, use \texttt{volatility_underlying1#underlying2} as the parameter name.
\end{itemize}
...
<Product type="CommoditySpreadOption">
    ...
    <EngineParameters>
        ...
        <Parameter name="volatility_NYMEX:CL#ICE:B">normal</Parameter>
        <Parameter name="SensitivityTemplate">COMM_Analytical</Parameter>
    </EngineParameters>
    </Product>
\end{minted}
