...
The NPV of payments that are only made if no credit event has occurred until the payment date are weighted in addition
...
\item npv\_credit\_linked: The NPV of the payments that are made only if no credit event has occurred until the payment date.
