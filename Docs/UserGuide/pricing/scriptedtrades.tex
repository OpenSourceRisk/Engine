...
There are no price sensitivities in respect to $\Delta N$ computed and since there is volatility in the process of redeemed units the price for both embedded options are underestimated.
