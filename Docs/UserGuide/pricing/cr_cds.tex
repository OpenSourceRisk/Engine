...
determined once a credit event has been deemed to have occurred. The recovery
...
credit sensitivities to each constituent while on the other hand the pricing is may not consistent to the market (using the index curve).
