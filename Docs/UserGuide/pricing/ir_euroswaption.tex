...
European Swaptions are priced using the Black model for log-normal and shifted
...
If the Black pricer does not support certain features of the underlying, a numerical pricing is used, as for
Bermudan swaptions (see \ref{pricing:ir_bermswaption}):

\begin{itemize}
\item the underlying has embedded caps / floors
\end{itemize}
