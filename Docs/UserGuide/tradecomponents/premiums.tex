...
\item SettlementData [Optional]: Converts the premium into a currency different. It specifies the payment currency, the FX index to perform the conversion, and the date on which the FX rate is fixed. Its XML form is shown in listing \ref{settlement_data_premiums}.
\begin{itemize}
