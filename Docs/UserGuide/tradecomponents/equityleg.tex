...
Allowable values: Any positive real number. If omitted or left blank it defaults to the equity spot price of the fixing at the valuation date associated with the start date.
