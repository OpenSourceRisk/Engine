...
Allowable values: Typically the MIC code of the exchange itself, or the Operating/parent MIC code. Mandatory when \lstinline!IdentifierType! is  \emph{ISIN}, should not be used when  \lstinline!IdentifierType! is \emph{RIC} and ignored otherwise.
