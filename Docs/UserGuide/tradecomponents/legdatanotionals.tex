...
Allowable values:  \emph{Fixed, Floating, Cashflow, CMS, CMB, DigitalCMS, DurationAdjustedCMS, CMSSpread, DigitalCMSSpread, Equity, CPI, YY, ZeroCouponFixed, CommodityFloating, CommodityFixed, EquityMargin}
