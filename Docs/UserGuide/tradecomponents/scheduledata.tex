...
\item \lstinline!IsEndDateExcluded! [Optional]: Specifies if the \lstinline!EndDate! must be excluded or included in the last computation period.
If excluded the EndDate is set to the previous calendar date.
