...
the specific usage in equity swaps. In what follows we describe the general structure of this component within an
arbitrary LegData node. The Indexing component can be used in combination with the following leg types:
...
The meanings and allowable values of the elements in each of the \lstinline!Indexing! nodes are as follows:
