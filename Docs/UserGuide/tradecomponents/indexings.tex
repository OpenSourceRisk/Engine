...
\begin{itemize}
\item FromAssetLeg [Optional]: If \emph{true} and the trade type supports this (e.g. equity swap) the trade
...
\item IndexFixingDays [Optional]: fixing days of the index, this is only used for FX indices
  ...
  Allowable values: Non-negative whole number. Defaults to \emph{0} if left blank or omitted.
