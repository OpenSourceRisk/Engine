...
FX Options (all variants, except Digital, Asian) &  \emph{Call}: Bought and Sold currencies/amounts stay as determined in the trade data node. 
...
\item PremiumAmount [Optional]: Option premium amount paid by the option buyer to the option seller. If negative, it's paid by the option seller to the option buyer.
