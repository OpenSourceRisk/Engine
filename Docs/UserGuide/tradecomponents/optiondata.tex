...
\item Style: The exercise style of the option. 
  ...
  \emph{European} or \emph{Bermudan}, but not \emph{American}.  FX, Equity and commodity options can have styles \emph{European}
  or \emph{American}, but not \emph{Bermudan}. Commodity Swaption and Commodity Average Price Option must have style \emph{European}. 
