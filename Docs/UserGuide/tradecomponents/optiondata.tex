...
\item Style: The exercise style of the option. 
  ...
  FX and Equity options trade can have styles \emph{European}
  or \emph{American}, but not \emph{Bermudan}. 
  
  Commodity Option, Commodity Swaption and Commodity Average Price Options must have style  \emph{European}. 
