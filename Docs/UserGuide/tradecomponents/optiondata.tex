...
FX Options (all variants, except Asian) &  \emph{Call}: Bought and Sold currencies/amounts stay as determined in the trade data node. 
...
Asian FX Options &  \emph{Call}: The right to buy/receive the underlying currency and sell/pay the currency in the \lstinline!Currency! field.  \newline \emph{Put}: The right to sell/pay  the underlying currency and buy/receive the currency in the \lstinline!Currency! field.   \\ \hline
