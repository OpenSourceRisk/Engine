...
+
+\begin{enumerate}
+\item If \lstinline!InterpolateOn\lstinline! is set to \lstinline!TermVolatilities!, \lstinline!InterpolationMethod! is used to interpolate the term volatilities during the bootstrap and to interpolate the optionlet volatlities of the final optionlet surface. Allowed values are \lstinline!Bilinear! and \lstinline!BicubicSpline!. If not given, the field defaults to \lstinline!BicubicSpline!. The fields \lstinline!TimeInterpolation! and \lstinline!StrikeInterpolation! are ignored in this case.
