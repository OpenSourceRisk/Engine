...
\begin{enumerate}
\item If \lstinline!InterpolateOn\lstinline! is set to \lstinline!TermVolatilities!, \lstinline!InterpolationMethod! is used to interpolate the term volatilities during the bootstrap and to interpolate the optionlet volatlities of the final optionlet surface. The fields \lstinline!TimeInterpolation! and \lstinline!StrikeInterpolation! are ignored in this case.
\item If \lstinline!InterpolateOn\lstinline! is set to \lstinline!OptionletVolatilities!, \listinline!TimeInterpolation! and \lstline!StrikeInterpolation! are used to interpolate optionlet volatilities both during the bootstrap and on the final optionlet surface. \lstinline!InterpolationMethod! is ignored in this case.
\end{enumerate}
