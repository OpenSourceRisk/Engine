...
\item \lstinline!OptionletTenorInArrears!:
If true, the tenor in the market data is the maturiy of the optionlet, if false, it is the start date of the optionlet instead. Default is true.

\item \lstinline!OptionletVolIsEffective!:
Applies to overnight indices only. If true, the input volatility is interpreted as effective volatility and converted to stripped volatility before inserting it into the optionlet surface.
...
<CapFloorVolatility>
  ...
  <OptionletTenorInArrears>...</OptionletTenorInArrears>
  <OptionletVolIsEffective>...</OptionletVolIsEffective>
</CapFloorVolatility>
\end{minted}
