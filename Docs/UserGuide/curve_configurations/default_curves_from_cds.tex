...
\item \lstinline!Type!:
For a default curve built from CDS, the \lstinline!Type! should be set to \lstinline!SpreadCDS! if the \lstinline!Quotes! reference CDS spread quotes or \lstinline!Price! if the \lstinline!Quotes! reference upfront price quotes or \lstinline!ConvSpreadCDS! if the \lstinline!Quotes! reference Conventional CDS spread quotes.  Note that if ConvSpreadCDS is used, the model will be IsdaCdsEngine. Else, MidPointCdsEngine.
