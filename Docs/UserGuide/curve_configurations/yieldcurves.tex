...
<YieldCurve>
  ...
  <CurveDescription>USD Libor 3M curve built from USD-SOFR curve and fallback spread</CurveDescription>
  <Currency>USD</Currency>
  <DiscountCurve/>
  <Segments>
    <IborFallback>
      ...
      <!-- optional, if not given the rfr index and sprad are read from the ibor fallback configuration -->
