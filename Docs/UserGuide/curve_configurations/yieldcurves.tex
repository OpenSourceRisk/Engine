...
In terms of discount factors the RHS of \ref{discount_ratio_rate1} and \ref{discount_ratio_rate2} can be written
...
and so \ref{discount_ratio_rates} can be written
