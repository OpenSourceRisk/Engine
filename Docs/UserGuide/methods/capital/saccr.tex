...
\begin{itemize}
  ...
  \item \textbf{saccr\_detail.csv}: Detailed breakdown of the SA-CCR calculation at the trade level. This file allows you to trace the contribution of each trade to the overall capital charge.
