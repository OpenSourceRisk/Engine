...
\item UseAssumedRecovery: Boolean flag to indicate whether to use specialized default curves bootstrapped with assumed recovery rates (mean of the stochastic recovery rate distribution). These curves are named \_\_CDO\_\<CurveName\>\_REC\_\<ASSUMED_RECOVERY_RATE\> and are used to derive the base correlations.
