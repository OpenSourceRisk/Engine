...
Listing \ref{lst:basecorr_upfront_configuration} shows the configuration of a Base Correlation curve from upfront quotes.
...
<BaseCorrelation>
  ...
  <QuoteType>TRANCHE_UPFRONT</QuoteType>
...
\item QuoteType: The type of quote used for the base correlation, e.g., TRANCHE_UPFRONT.
