...
<Analytics>
  <Analytic type="correlation">
      ...
      <Parameter name="filteredTenorCorrelationRFMapping">{"DiscountCurve/USD":"2Y", "IndexCurve/USD-FedFunds":"1Y"}</Parameter>
      <Parameter name="mporDays">10</Parameter>
      <Parameter name="mporCalendar">USD</Parameter>
...
\item {\tt filteredTenorCorrelationRFMapping}: JSON object mapping risk factor names to their representative tenors for the filtered correlation output, e.g. \verb+{"DiscountCurve/USD":"2Y", "IndexCurve/USD-FedFunds":"1Y"}+. This allows overriding the default {\tt filteredCorrelationScenarioTenor} on a per-risk-factor basis.
