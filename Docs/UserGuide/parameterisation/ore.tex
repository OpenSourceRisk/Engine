...
<Analytics>
  <Analytic type="correlation">
      ...
      <Parameter name="filteredCorrelationScenarioTenor">2Y</Parameter>
      <Parameter name="filteredCorrelationScenarioTenorOverrides">{"DiscountCurve/USD":"2Y", "IndexCurve/USD-FedFunds":"1Y"}</Parameter>
      <Parameter name="mporDays">10</Parameter>
      <Parameter name="mporCalendar">USD</Parameter>
...
\item {\tt filteredCorrelationScenarioTenor}: Tenor used to filter the correlation output to a single representative tenor per yield curve risk factor.
\item {\tt filteredCorrelationScenarioTenorOverrides}: JSON object mapping risk factor names to their representative tenors for the filtered correlation output, e.g. \verb+{"DiscountCurve/USD":"2Y", "IndexCurve/USD-FedFunds":"1Y"}+. This allows overriding the default {\tt filteredCorrelationScenarioTenor} on a per-risk-factor basis.
