...
minimal counterarty-level information needed in a few capital analytics as shown in example section \ref{example68}.
...
\begin{itemize}
\item npv, cashflow, todaysMarketCalibration, curves
\item calibration, simulation
\item xva
\item sensitivity
\item stress
\item par conversion, par stress conversion, par scenario
\item xva stress, xva sensitivities, xva explain
\item var, imschedule, ISDA simm
\item sacva, saccr, bacva, smrc
\item scenario statistics
...
See Example\_8 for a demonstration.
...
\medskip The {\tt XVA stress} and {\tt XVA sensitivity} 'analytics' provide computation of bump and revalue 
...
The XVA sensitivity analytics configuration is similar to the one of the XVA stress calculation. Listing \ref{lst:lst:ore_xva_sensi}
shows an example.
...
For both analytics ORE reuses the parameterisations of the exposure and XVA analtyic. One need to setup those analytics as usual but one can deactivate them. See listings \ref{lst:ore_xva} and \ref{lst:ore_simulation}. If set to active, ORE will run the 
regular XVA analytic and the XVA sensitivity or XVA stress analytic respectively.

\medskip The {\tt XVA explain} 'analytic' provide the computation of the market implied changes of the value adjustments 
...
ORE reuses the parameterisations of the exposure and XVA analtyic. One needs to setup those analytics as usual but one can deactivate them. See listings 
\ref{lst:ore_xva} and \ref{lst:ore_simulation}. If set to active, ORE will run the 
regular XVA analytic and the XVA sensitivity or XVA stress analytic respectively.

\medskip The {\tt sacva} 'analytic' provides computation of SA-CVA capital calculation based on CVA sensitivities.
...
\medskip The {\tt saccr} 'analytic' provides computation of SA-CCR capital calculation, see \ref{lst:ore_saccr}. The required input in
...
\medskip The {\tt bacva} 'analytic' provides computation of BA-CVA capital calculation, see \ref{lst:ore_bacva}.
