...
<Swap>
  ...
  <ShiftParSensitivity> </ShiftParSensitivity>
</Swap>
\end{minted}
...
\item ShiftParSensitivity [Optional Boolean]: True, use historical fixing on the valuation date when calculating the sensitivities of par instruments to zero rates. Default to False, ignore it.
\end{itemize}
