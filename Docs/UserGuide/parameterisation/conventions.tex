...
<BMABasisSwap>
  ...
  <IndexPaymentFrequency> </IndexPaymentFrequency>
  <IndexEOM> </IndexEOM>
  <IndexRule> </IndexRule>
  <OvernightSpotLag> </OvernightSpotLag>
  <OvernightRateCutoff> </OvernightRateCutoff>
</BMABasisSwap>
\end{minted}
...
\item PaymentCalendar [Optional]: The payment calendar, applicable to both legs. If not specified, defaults to NullCalendar.
\item PaymentConvention [Optional]: The payment convention, applicable to both legs. If not specified, defaults to Following.
\item BMAPaymentLag [Optional]: The payment lag on the BMA / SIFMA leg. If not specified, defaults to $0$.
\item IndexPaymentLag [Optional]: The payment lag on the reference leg. If not specified, defaults to $0$.
\item IndexPaymentFrequency [Optional]: The payment frequency on the reference leg. If not specified, defaults to ``quarterly''.
\item IndexEOM [Optional]: Whether the reference leg follows eom-convention. If not specified, defaults to false.
\item IndexRule [Optional]: The date generation rule for the reference leg. If not specified, defaults to ``backward''.
\item OvernightSpotLag [Optional]: The spot settlement lag to be applied to the reference leg. If not specified,
  defaults to $0$. Only applies to (compounding) overnight reference lags.
\item OvernightRateCutoff [Optional]: The rate cutoff to be applied to the reference leg. If not specified,
  defaults to $0$. Only applies to (compounding) overnight reference lags.
\end{itemize}
