...
\begin{itemize}
\item Rate: The underlying rate.

Allowable values:  Any real number. The rate is expressed in decimal form, e.g. 0.05 is a rate of 5\%.

\item Years: The number of years the rate is compounded for.

Allowable values: An integer, the trade is expected to compund for an integer number of years,
