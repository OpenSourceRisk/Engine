...
\item NotionalReset [Optional]: Defaults to \emph{false}. If set to \emph{true}, the Notional is reset at the beginning of each coupon period.
\item DividendFactor [Optional]: Factor of dividend to be included in return. Defaults to \emph{1}.
