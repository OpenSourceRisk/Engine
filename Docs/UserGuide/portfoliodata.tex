...
not being rules based (sub-node Rules doesn't exist), the \lstinline!ScheduleData! node includes a \lstinline!Dates! sub-node
...
\begin{itemize}
\item Rules: sub-node that determines whether the schedule is set by specifying rules that
