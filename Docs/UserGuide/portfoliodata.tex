...
FX Option &  \emph{Call}: Bought and Sold currencies/amounts stay as determined in the Option Data node. 
\newline \emph{Put}: Bought and Sold currencies/amounts are switched compared to the Option Data node.  \\ \hline
  \end{tabu}
...
Allowable values:  \emph{Fixed, Floating, Cashflow, CMS, CMSSpread, YY, CPI}
...
\subsubsection{CMSSpread Leg Data}
...
\centering
  \begin{tabu} to 0.9\linewidth {| X[-1.5,l,m] | X[-5,l,m] |}
    ...
    \emph{A365, A365F, Actual/365, Actual/365 (fixed), Actual/365 (Fixed)} & Actual 365 Fixed \\ \hline
    ...
    \emph{ActActISDA, ActualActual (ISDA), Actual/Actual (ISDA), ACT/ACT, ACT} & Actual Actual (ISDA) \\ \hline
    \emph{ActActISMA, ActualActual (ISMA), Actual/Actual (ISMA)} & Actual Actual (ISMA) \\ \hline
