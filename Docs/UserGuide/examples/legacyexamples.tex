...
\item includeExpectedShortfall (optional): boolean, if {\tt Y} additional {\tt ExpectedShortfall\_<quantile>} columns are appended to the report, giving the average P\&L of all scenarios at or below the VaR level for each quantile; defaults to {\tt N}
