...
%There is no need to add lots of --with-blah-include=.... flags

%On Windows: \\
%Open QuantExt.sln and build all.
%This will build both the QuantExt library and test suite.

%\todo[inline]{The test suite links to
%{\tt ../../QuantLib/lib;\$(BOOST)/lib/\$(Platform)/lib}
%How does this work with 32/64 bit builds? how does it work with Release/Debug??}
...
The visualisation examples in section \ref{sec:visualisation} use Jupyter notebooks. 
