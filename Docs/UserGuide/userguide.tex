...
\end{center}
\caption{Vanilla ATM swap expected exposure in a flat market environment from both parties' perspectives (monthly time grid with 5000 samples). The black line and symbols are European Swaption prices.}
\label{fig_1}
\end{figure}
...
%--------------------------------------------------------
\subsection{Capped/Floored Swap Exposures}\label{sec:capfloor}
%--------------------------------------------------------

\todo[inline]{Add Cap/Floor exposures}
...
\end{center}
\caption{Three swaps netting set, THR=1m EUR, MTA=100k EUR, MPoR=2w. The red evolution assumes that the each trade is terminated at the next break date. The blue evolution ignores break dates. }
\label{fig_9}
\end{figure}
...
\hline
 & CPTY\_A & 31,163 & 44,950 & -4,815 & 21,208 & 1,965 &  179,961 \\
Swap\_1 & CPTY\_A & 116,263 & 211,990 & -17,916 & 100,632 & n/a & n/a \\
Swap\_2 & CPTY\_A & 67,608 & 96,233 & -10,576 & 45,402 & n/a & n/a \\
Swap\_3 & CPTY\_A & 71,364 & 85,041 & -11,280 & 40,467 & n/a & n/a \\
\hline
\end{tabular}
\end{center}
...
<Setup>
  ...
  <Parameter name="observationModel">Disable</Parameter> <!-- None, Unregister, or Disable -->
</Setup>
\end{minted}
%\hrule
...
The last parameter {\tt observationModel} is used to decide whether and how observer notifications are limited to improve performance during simulation. The 'unregister' option limits the amount of notifications by unregistering floating rate coupons from indices. The 'disable' option goes one step further and disables all notifications during market updates and triggers instrument recalculations explicitly. 
