...
The project hopes to reach quantitative risk ma\-nage\-ment practitioners (be it in financial institutions, audit firms, consulting companies or regulatory bodies) who are looking for accessible software solutions, quant developers charged with the implementation of the kind of simulation methods and models provided by ORE, but likewise academics and students who would like to teach or learn quantitative risk management with the help of a freely available risk application.  
...
More information about ORE is available
\begin{itemize}
\item on the Open Risk Engine project pages \url{http://www.openriskengine.org}
\item {\color{red}in the FAQ section at \url{http://www.openriskengine.org/FAQ}}
\item {\color{red}in the ORE forum at ...}
\item following Open Risk Engine on Twitter {\tt @OpenRiskEngine}
\end{itemize}
Moreover, an Open Risk Engine Book will follow in 2017 that will elaborate on the engine's design and make the connection between methodology and implementation. Like ORE, the book will be available for free. It will be announced in due course on the channels mentioned above.
