...
\centering
  \begin{tabu} to 0.9\linewidth {| X[-1.5,l,m] | X[-5,l,m] |}
    ...
    \bfseries{Allowable Values} & \bfseries{Resulting Commodity Curve} \\
    Any string (provided it is the ID of an equity in the market configuration) & The resulting curve\\
  \end{tabu}
