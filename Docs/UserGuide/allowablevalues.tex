...
This full list of currencies is available via loading {\tt currencies.xml} at start-up, see section \ref{sec:configuration}.
...
GBP-SONIA\\ GBP-LIBOR\\ GBP-CMS \\ GBP-BOEBaseRate \\ 
