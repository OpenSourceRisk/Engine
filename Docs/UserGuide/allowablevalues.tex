...
\begin{longtable}{| p{.30\textwidth} | p{.70\textwidth} |}
    ...
    \hline
    \emph{TARGET, TGT, EUR, EUTA} & Target Calendar  \\ \hline
    \emph{CA, CAN, CAD, TRB, CATO} & Canada Calendar \\ \hline
    \emph{JP, JPN, JPY, TKB, JPTO} & Japan Calendar \\ \hline
    \emph{CH, CHE, CHF, ZUB, CHZU} & Switzerland Calendar \\ \hline
    \emph{GB, GBR, GBP, LNB, UK, GBLO, GBp, GBX, UK settlement} & UK Calendar \\ \hline
    \emph{US, USA, USD, NYB} & US Calendar \\ \hline
    \emph{US-SET, USNY, US settlement} & US Settlement Calendar \\ \hline
    \emph{US-FED} & US Federal Reserve Calendar \\ \hline
    ...
    \emph{US-SOFR, SOFR fixing calendar} & US SOFR fixing Calendar \\ \hline
    \emph{AR, ARG, ARS} & Argentina Calendar \\ \hline    
    \emph{AU, AUD, AUS, SYB} & Australia Calendar \\ \hline
    \emph{AT, AUT, ATS} & Austria Calendar \\ \hline    
    \emph{BE, BEL, BEF, BEBR} & Belgium Calendar \\ \hline    
    ...
    \emph{CN-IB} & China Inter-Bank Calendar \\ \hline
    ...
    \emph{DE, DEU, FRA} & Germany Calendar \\ \hline
    ...
    \emph{IL, ISR, ILS, ILa, ILX, ILs, ILA} & Israel Calendar \\ \hline
    ...
    \emph{MU, MUR, MUS} & Mauritius Calendar \\ \hline
    \emph{NL, NLD, NGL} & Netherlands Calendar \\ \hline
    \emph{NZ, NZL, NZD} & New Zealand Calendar\\ \hline
    \emph{NO, NOR, NOK} & Norway Calendar \\ \hline
    \emph{PE, PER, PEN} & Peru Calendar \\ \hline
    \emph{PH, PHL, PHP} & Philippines Calendar \\ \hline
    \emph{PL, POL, PLN} & Poland Calendar \\ \hline
    ...
    \emph{XLON, London stock exchange} & UK London Stock Exchange \\ \hline
    ...
    \emph{BHD, CLF, EGP, KWD, KZT, MAD, MXV, NGN, OMR, PKR, QAR, TND, UYU, VND} & Weekends Only (fallback for these currencies; may be adjusted via {\tt calendaradjustmentconfig.xml}) \\ \hline
    \emph{AOA, BGN, ETB, GEL, GHS, HRK, JOD, KES, LKR, RSD, UGX, XOF, ZMW} & Weekends Only (fallback for these currencies; may be adjusted via {\tt calendaradjustmentconfig.xml}) \\ \hline
  ...
  \caption{Allowable Values for Calendar. Combinations of calendars can be provided using comma separated calendar names. Full English country names (e.g.\ \emph{Australia}, \emph{Canada}, \emph{Japan}, \emph{Switzerland}, \emph{New Zealand}) are also accepted for the respective settlement calendars.}
  \label{tab:calendar}
\end{longtable}
