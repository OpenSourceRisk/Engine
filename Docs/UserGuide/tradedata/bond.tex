...
\item CreditCurveId: The identifier of the default curve used for pricing.

Allowable values: See \lstinline!Name! for credit trades in Table \ref{tab:equity_credit_data}. \\
