...
\end{align*}
so that the long digital option has positive value in both cases. The strike spread $\Delta$ used here is set to 1\% of strike $K$. However, the default 1\% can be overridden by setting the 'StrikeSpread' parameter in the pricing engine global parameters.
