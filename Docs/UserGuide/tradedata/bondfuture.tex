...
see \ref{lst:bondfuturetradedata}.
...
\begin{itemize}
  ...
  \item DeliveryBasket: A list of eligible securities/bond identifiers. Allowable Values: A valid bond identifier, typically the ISIN of the reference bond with the ISIN: prefix
