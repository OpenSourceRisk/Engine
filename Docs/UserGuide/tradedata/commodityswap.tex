...
The \lstinline!SwapData! node may contain two or more \lstinline!LegData! nodes. There must be at least one \lstinline!LegData! node of a commodity \lstinline!LegType!, i.e. \lstinline!CommodityFixed!, \lstinline!CommodityFloating! or \lstinline!IntradayPowerFloating!, but non-commodity leg types are also allowed. The commodity leg types are described in sections \ref{ss:commodityfixedleg}, \ref{ss:commodityfloatingleg} and \ref{ss:intradaypowerfloatingleg} respectively.
