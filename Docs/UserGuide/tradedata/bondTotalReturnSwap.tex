...
\item The {\tt BondData} block specifies the underlying bond, usually by specifiying the security id and the quantity /
  ...
  \item SecurityId: The underlying security identifier\\
      ...
      Note that Convertible Bonds are not supported as underlyings for BondTRS. For Convertible Bonds, trade type \emph{TotalReturnSwap} \ref{ss:GenericTRS} should be used instead.
