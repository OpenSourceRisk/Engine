...
\item Currency: The  currency the underlying commodity is quoted in. The Strike and the Forward price of the underlying commodity are both considered to be in this currency.   \\
...
\item \lstinline!SettlementData! [Optional]: This node is used to specify  the settlement of the cash flows for non-deliverable futures, i.e. when \lstinline!PhysicallySettled! is \emph{false}.
\end{itemize}
