...
\item Settlement [Optional]: Delivery type.  Note that FX Forwards with physical settlement are exempt from SIMM\textsuperscript{\textregistered}   \\Allowable values: \emph{Cash} or \emph{Physical}.  Defaults to \emph{Physical} if left blank or omitted.
