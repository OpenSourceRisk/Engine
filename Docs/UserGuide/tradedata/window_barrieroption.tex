...
\item Strike [Optional]: For FxWindowBarrierOptions: The fx strike rate is defined as amount in domestic currency
...
\item BarrierData: Specification of the barrier type and level. The barrier is continuously monitored between the
