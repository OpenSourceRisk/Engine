...
\begin{itemize}
   \item BondData: A {\tt BondData} block specifying the underlying bond as described in section~\ref{ss:bond}. A long
     ...
     \item SpreadOnIncomeFallback: In case the IncomeCurveId is omitted, hence the fallback is the reference yield curve is used,
      this flag enables the addition of the bond spread to the reference curve. Default value is {\tt false}, i.e. spread will not be added.
    \end{itemize}
  ...
  \begin{minted}[fontsize=\small]{xml}
   <ForwardBondData>
     <BondData>
      ...
      <SpreadOnIncomeFallback>true<SpreadOnIncomeFallback>
     </BondData>
     <SettlementData>
