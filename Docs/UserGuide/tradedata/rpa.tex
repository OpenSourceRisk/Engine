...
In a fixed recovery RPA, the recovery rate that is used to determine the payment on the occurrence of a credit event is
...
\item BondData: Reference to the underlying security, given in the BondData sub node, minimum required data are notional and security ID \\
