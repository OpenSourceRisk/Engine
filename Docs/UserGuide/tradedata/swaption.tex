...
have the same value for all \lstinline!LegData! sub-nodes of a swaption. Unless \lstinline!MidCouponExercise! isset to \emph{true}, there must be at least one full coupon period after the exercise date for European 
