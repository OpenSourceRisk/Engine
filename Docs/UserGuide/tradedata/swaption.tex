...
\begin{tabular} {|l|p{10cm}|}
    ...
    \lstinline!Currency! & The currency of each \lstinline!LegData! sub-node. The underlying swap may be single-currency (all legs share the same currency) or cross-currency (legs in two different currencies).\\ \hline
...
Like the underlying swaption, a swaption straddle may be single-currency or cross-currency, since it is constructed as two opposite-direction swaptions sharing the same \lstinline!LegData!. 
