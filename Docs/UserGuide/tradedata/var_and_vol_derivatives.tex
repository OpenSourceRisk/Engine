...
IF currPrice >= SpotBarrierLevel AND isTerminalOnly == 1  THEN
  Alive = 0;
END;
...
\begin{itemize}
  ...
  Allowable values: Any non-negative real number.
  \item{}[boolean] \lstinline!isTerminalOnly!: Determine if the Spot Barrier occurs on every valuation date or at End Date. \\
  ...
  Allowable values: Any non-negative real number.
  \item{}[currency] \lstinline!PayCcy!: The payment currency of the premium and option. For FX, where the underlying is provided
      in the form \lstinline!FX-SOURCE-CCY1-CCY2! (see Table \ref{tab:fxindex_data}) this should
      be \lstinline!CCY2!. If \lstinline!CCY1! or the currency of the underlying (for EQ and
