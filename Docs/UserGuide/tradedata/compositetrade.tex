...
A composite trade is a hybrid position consisting of multiple component subtrades. As such it inherits the characteristics of the trades defined within it. Examples of Composite Trades include combinations of vanilla options like straddles.

The \lstinline!CompositeTradeData!  node is the trade data container for the  \emph{CompositeTrade} trade type.   A composite trade is a hybrid position consisting of multiple component subtrades. The structure of an example \lstinline!CompositeTradeData! node for a commodity option is shown in 
