...
\begin{itemize}
\item Currency: The currency in which the FX Forward is settled. This field is used only if Settlement is \emph{Cash} and the payment date is greater
than the value date. Otherwise, it is ignored. \\
