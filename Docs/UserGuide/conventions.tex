...
<FxOption> 
  <Id> </Id>
  <FXConventionID> </FXConventionID>
  <AtmType> </AtmType> 
  <DeltaType> </DeltaType> 
  <SwitchTenor> </SwitchTenor>
  <LongTermAtmType> </LongTermAtmType>
  <LongTermDeltaType> </LongTermDeltaType>
  <RiskReversalInFavorOf> </RiskReversalInFavorOf>
  <ButterflyStyle> </ButterflyStyle>
</FxOption> 
\end{minted} 
...
The meanings of the various elements in this node are as follows: 
\begin{itemize}
\item FXConventionID: The FX convention for the currency pair (see \ref{sss:fx_convention})
