...
\item FixingCalendar [Optional]: The fixing calendar for the swap index fixings publication. If not given, the fixing
  calendar of the Ibor index given in the swap conventions is used as a fall back.
\end{itemize}
