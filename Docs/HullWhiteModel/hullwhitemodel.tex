...
under the bank account meausre, where $P(t,T)$ is the zero bond price with maturity $T$ as seen from time $t$, $r(t)$ is
...
\subsubsection{Sepearate component modeling}
