...
An analytical pricing formula for European swaptions under the Hull-White n-factor model can be derived using the
Jamshidian approach. We outline the method following \cite{Andersen_Piterbarg_2010}, Lemma 12.1.19.
