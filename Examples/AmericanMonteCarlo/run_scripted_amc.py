...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_EOB_EUR_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_EOB_EUR_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_EOB_AMC_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_EOB_AMC_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_WBO_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_WBO_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_BEO_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_BEO_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_SRO_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_SRO_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_ACC01_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_ACC01_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_ACC02_FX.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_ACC02_FX.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
...
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_KOS_USD.csv", 2, 3, 'b', "AMC EPE", linestyle='-')
oreex.plot("scripted_amc/exposure_trade_SCRIPTED_KOS_USD.csv", 2, 4, 'r', "AMC ENE", linestyle='-')
