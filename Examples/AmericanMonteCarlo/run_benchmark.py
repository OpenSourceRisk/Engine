...
print("+-----------------------------------------------------+")
print("| AMC: Bechnmark AMC vs Classic                       |")
print("+-----------------------------------------------------+")
...
oreex.decorate_plot(title="Simulated exposure for 10y10y EUR Bermudan Payer Swaption")
...
oreex.decorate_plot(title="Simulated exposure for 20y EUR Payer Swap")
oreex.save_plot_to_file()
...
oreex.decorate_plot(title="Simulated exposure for FX Call Option EUR-USD")
oreex.save_plot_to_file()
...
oreex.decorate_plot(title="Simulated exposure for XCcy Swap EUR-USD")
oreex.save_plot_to_file()
...
oreex.decorate_plot(title="Simulated exposure for the netting set")
oreex.save_plot_to_file()
...
oreex.plot("amccg/exposure_trade_FX_CALL_OPTION_FEE.csv", 2, 3, 'm', "AMC-CG FX Call Option EPE with FEE")
oreex.plot("amccg/exposure_trade_FX_CALL_OPTION_FEE.csv", 2, 4, 'c', "AMC-CG FX Call Option ENE with FEE")
oreex.plot("classic/exposure_trade_FX_CALL_OPTION.csv", 2, 3, 'g', "Classic FX Call Option EPE")
oreex.plot("classic/exposure_trade_FX_CALL_OPTION.csv", 2, 4, 'y', "Classic FX Call Option ENE")
oreex.decorate_plot(title="Simulated exposure for FX Call Option EUR-USD")
oreex.save_plot_to_file()
