...
oreex.plot(os.path.join("portfolio_1", "exposure_trade_swap_01.csv"), 2, 3, 'b', "EPE Swap", offset=1, marker='', linestyle='--')
oreex.plot(os.path.join("portfolio_1", "exposure_trade_swap_01.csv"), 2, 4, 'b', "ENE Swap")
oreex.plot(os.path.join("portfolio_1", "exposure_trade_collar_01.csv"), 2, 3, 'r', "EPE Collar", offset=1, marker='', linestyle='--')
...
oreex.plot(os.path.join("portfolio_2", "exposure_nettingset_CPTY_B.csv"), 2, 3, 'b', "EPE Netted", offset=1, marker='', linestyle='--')
oreex.plot(os.path.join("portfolio_2", "exposure_nettingset_CPTY_B.csv"), 2, 4, 'r', "ENE Netted", offset=1, marker='', linestyle='--')
oreex.plot(os.path.join("portfolio_2", "exposure_trade_collar_02.csv"), 2, 3, 'g', "EPE Collar", offset=1, marker='o', linestyle='')
