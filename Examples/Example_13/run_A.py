...
oreex.decorate_plot(title="Plus Example 3 (A) - DIM Evolution Swap EUR", xlabel="Timestep", ylabel="DIM")
oreex.save_plot_to_file()

oreex.setup_plot("dim_regression_A_swap_eur")
oreex.plotSq(os.path.join("case_A_eur_swap", "dim_regression_1.txt"), 1, 6, 'k', "Delta NPV", marker=',', linestyle='', rescale=True)
oreex.plotSq(os.path.join("case_A_eur_swap", "dim_regression_1.txt"), 1, 5, 'y', "Zero Order Regression")
oreex.plotSq(os.path.join("case_A_eur_swap", "dim_regression_1.txt"), 1, 2, 'c', "First Order Regression")
oreex.plotSq(os.path.join("case_A_eur_swap", "dim_regression_2.txt"), 1, 2, 'm', "Second Order Regression", title="Plus Example 3 (A) - DIM Regression Swap EUR, Timestep 100", xlabel="Regressor", ylabel="V")
oreex.save_plot_to_file()
