...
oreex.plotSq(os.path.join("case_B_eur_swaption", "dim_regression_2.txt"), 1, 2, 'm', "Second Order Regression", marker='.', linestyle='', title="Plus Example 3 (B) - DIM Regression Swaption (physical delivery) EUR, Timestep 300", xlabel="Regressor", ylabel="V", rescale = True)
oreex.save_plot_to_file()
...
oreex.plotSq(os.path.join("case_B_eur_swaption", "dim_regression_2b.txt"), 1, 2, 'm', "Second Order Regression", marker='', linestyle='-', title="Plus Example 3 (B) - DIM Regression Swaption (physical delivery) EUR, Timestep 100", xlabel="Regressor", ylabel="V", rescale = True)
oreex.save_plot_to_file()
