...
oreex.run("Input/ore_eur_amc.xml")
oreex.get_times("Output/log.txt")

oreex.print_headline("Plot AMC results")

oreex.setup_plot("example_bermudan_swaption_eur_10_10")
...
oreex.run("Input/ore_eur_grid.xml")
oreex.get_times("Output/log.txt")
...
oreex.decorate_plot(title="EUR Bermudan Swaption 10Yx10Y", ylabel="Exposure")
