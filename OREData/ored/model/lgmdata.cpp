...
bool LgmData::operator==(const LgmData& rhs) {
    ...
    if (qualifier_ != rhs.qualifier_ || calibrationType_ != rhs.calibrationType_ || revType_ != rhs.revType_ ||
        ...
        aValues_ != rhs.aValues_ || shiftHorizon_!= rhs.shiftHorizon ||scaling_ != rhs.scaling_ || optionExpiries_ != rhs.optionExpiries_ ||
        optionTerms_ != rhs.optionTerms_ || optionStrikes_ != rhs.optionStrikes_ || calibrationStrategy_ != rhs.calibrationStrategy_) {
        return false;
    }
    return true;
}
