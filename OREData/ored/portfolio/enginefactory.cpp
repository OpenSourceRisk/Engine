...
void EngineFactory::addDefaultBuilders() {
    ...
    registerBuilder(boost::make_shared<FxEuropeanVanillaOptionAnalyticEngineBuilder>());
    registerBuilder(boost::make_shared<FxAmericanVanillaOptionFDEngineBuilder>());
    registerBuilder(boost::make_shared<FxAmericanVanillaOptionBAWEngineBuilder>());
    ...
    registerBuilder(boost::make_shared<EquityEuropeanVanillaOptionAnalyticEngineBuilder>());
    registerBuilder(boost::make_shared<EquityAmericanVanillaOptionFDEngineBuilder>());
    registerBuilder(boost::make_shared<EquityAmericanVanillaOptionBAWEngineBuilder>());
