...
void FxDoubleTouchOption::build(const boost::shared_ptr<EngineFactory>& engineFactory) {
    ...
    underlying->setPricingEngine(swapBuilder->engine(parseCurrency(payoffCurrency_), std::string()));
