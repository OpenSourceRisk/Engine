...
protected:
    ...
    virtual string keyImpl(const string& id, const Currency& ccy, const string& bondspreadId,
        ...
        std::string returnString = ccy.code() + "_" + discountCurveName + "_" + creditCurveId + "_" + bondspreadId +
                                   "_" + securityId + "_" + referenceCurveId + "_" + incomeCurveId;
...
private:
    ...
    buildMcEngine(const QuantLib::ext::shared_ptr<QuantExt::LGM>& lgm, const Handle<YieldTermStructure>& discountCurve,
                  ...
                  const Handle<YieldTermStructure>& discountContractCurve, const Handle<Quote>& conversionFactor);
