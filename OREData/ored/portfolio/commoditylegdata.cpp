...
CommodityFixedLegData::CommodityFixedLegData()
    : ore::data::LegAdditionalData("CommodityFixed", false),
...
CommodityFixedLegData::CommodityFixedLegData(const vector<Real>& quantities, const vector<string>& quantityDates,
    ...
    : LegAdditionalData("CommodityFixed", false), quantities_(quantities), quantityDates_(quantityDates), prices_(prices),
...
CommodityFloatingLegData::CommodityFloatingLegData()
    : ore::data::LegAdditionalData("CommodityFloating", false),
...
CommodityFloatingLegData::CommodityFloatingLegData(
    ...
    : LegAdditionalData("CommodityFloating", false), name_(name), priceType_(priceType), quantities_(quantities),
