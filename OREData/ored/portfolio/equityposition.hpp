...
public:
    ...
    const std::vector<boost::shared_ptr<QuantExt::EquityIndex2>>& indices() const { return indices_; }
...
private:
    ...
    std::vector<boost::shared_ptr<QuantExt::EquityIndex2>> indices_;
...
public:
    ...
    EquityPositionInstrumentWrapper(const Real quantity,
                                    const std::vector<boost::shared_ptr<QuantExt::EquityIndex2>>& equities,
...
private:
    ...
    Real quantity_;
    std::vector<boost::shared_ptr<QuantExt::EquityIndex2>> equities_;
    std::vector<Real> weights_;
    std::vector<Handle<Quote>> fxConversion_;
