...
public:
    DurationAdjustedCmsLegData()
        : ore::data::LegAdditionalData(LegType::DurationAdjustedCMS), fixingDays_(Null<Size>()), isInArrears_(true),
          nakedOption_(false) {}
    ...
    DurationAdjustedCmsLegData(const std::string& swapIndex, Size duration, Size fixingDays, bool isInArrears,
        ...
        : LegAdditionalData(LegType::CMS), swapIndex_(swapIndex), duration_(duration), fixingDays_(fixingDays),
