...
public:
    //! Default constructor
    EquityMarginLegData() : ore::data::LegAdditionalData("EquityMargin", false) {}
    //! Constructor
    EquityMarginLegData(QuantLib::ext::shared_ptr<ore::data::EquityLegData>& equityLegData, const vector<double>& rates, 
        ...
        : ore::data::LegAdditionalData("EquityMargin", false), equityLegData_(equityLegData), rates_(rates), rateDates_(rateDates), 
