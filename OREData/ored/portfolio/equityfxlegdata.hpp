...
public:
    //! Default constructor
    EquityMarginLegData() : ore::data::LegAdditionalData(LegType::EquityMargin) {}
    //! Constructor
    EquityMarginLegData(QuantLib::ext::shared_ptr<ore::data::EquityLegData>& equityLegData, const vector<double>& rates, 
        ...
        : ore::data::LegAdditionalData(LegType::EquityMargin), equityLegData_(equityLegData), rates_(rates), rateDates_(rateDates), 
