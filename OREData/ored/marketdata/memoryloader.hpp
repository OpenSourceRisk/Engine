...
public:
    //! Constructor
    MemoryLoader( //! QuantLib::Date Key Value in a single std::string, separated by blanks, tabs, colons or commas
...
private:
    void load(const std::vector<std::string>&, bool);
