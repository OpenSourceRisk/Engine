...
/* This class is the basis for BlackScholes, LocalVol, Heston, SLV model implementations */
class AssetModel : public ModelImpl {
public:
...
protected:
    ...
    virtual Real initialValue(const Size indexNo) const = 0;
    virtual Real atmForward(const Size indexNo, const Real t) const = 0;
    virtual Real compoundingFactor(const Size indexNo, const Date& d1, const Date& d2) const = 0;
