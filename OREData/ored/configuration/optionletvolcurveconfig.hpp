...
/*! \file ored/configuration/optionletvolcurveconfig.hpp
    \brief Optionlet volatility curve configuration class
...
/*! Optionlet volatility curve configuration class
    \ingroup configuration
 */
class OptionletVolatilityCurveConfig : public CurveConfig {
public:
    ...
    //! Default constructor
    OptionletVolatilityCurveConfig() {}
...
//! Imply QuantLib::VolatilityType from OptionletVolatilityCurveConfig::VolatilityType
QuantLib::VolatilityType volatilityType(OptionletVolatilityCurveConfig::VolatilityType type);
